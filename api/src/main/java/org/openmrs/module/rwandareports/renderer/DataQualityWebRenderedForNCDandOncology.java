 ...
 *
 */
public class DataQualityWebRenderedForNCDandOncology extends IndicatorReportWebRenderer implements WebReportRenderer {
	...
	public Collection<RenderingMode> getRenderingModes(ReportDefinition definition) {
		...
		for (Map.Entry<String, Mapped<? extends DataSetDefinition>> e : definition.getDataSetDefinitions().entrySet()) {
	    	...
	    	if ("DQ-Data Quality Report for NCD Data Set".equals(def.getName())) {
