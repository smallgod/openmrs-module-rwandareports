...
public class AllObsValuesByRemovingUnwantedEncountersEvaluator implements RowPerPatientDataEvaluator {
    ...
    public PatientDataResult evaluate(RowPerPatientData patientData, EvaluationContext context) {
        ...
        List<Encounter> encs = Context.getEncounterService().getEncounters(pd.getPatient(),null,null,endDate,pd.getForms(),null,null,null,null,false);
        ...
        if(encs.size()>0){
            ...
            List<Obs> obs = Context.getObsService().getObservations(null,encs,listOfConceptOfWantedObs,null,null,null,null,null,null,null,endDate,false);
