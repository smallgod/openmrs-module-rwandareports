...
public class SetupOncologyCancerCenterClinicMissedVisit extends SingleSetupReport {
	...
	public void setup() throws Exception {
		...
		ReportDesign design = Helper.createRowPerPatientXlsOverviewReportDesign(rd, "OncologyRwandaCancerCenterClinicMissedVisit.xls",
		    "OncologyRwandaCancerCenterClinicMissedVisit.xls_", null);
	...
	private void createDataSetDefinition(ReportDefinition reportDefinition) {
		...
		//Add Columns
		dataSetDefinition.addColumn(RowPerPatientColumns.getMostRecent("nextRDV", rwandaCancerCenterChemotherapy, "dd/MMM/yyyy"), new HashMap<String, Object>());
