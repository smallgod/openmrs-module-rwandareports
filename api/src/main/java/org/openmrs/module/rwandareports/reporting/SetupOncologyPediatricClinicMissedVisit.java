...
public class SetupOncologyPediatricClinicMissedVisit extends SingleSetupReport {
	...
	private void createDataSetDefinition(ReportDefinition reportDefinition) {
		...
		//Add Columns
		dataSetDefinition.addColumn(RowPerPatientColumns.getMostRecent("nextRDV", pediatricChemotherapy, "dd/MMM/yyyy"), new HashMap<String, Object>());
		dataSetDefinition2.addColumn(RowPerPatientColumns.getMostRecent("nextRDV", pediatricNonChemotherapy, "dd/MMM/yyyy"), new HashMap<String, Object>());

		dataSetDefinition.addColumn(RowPerPatientColumns.getMostRecent("nextRDVDate", pediatricChemotherapy, "yyyy/MM/dd"), new HashMap<String, Object>());
		dataSetDefinition2.addColumn(RowPerPatientColumns.getMostRecent("nextRDVDate", pediatricNonChemotherapy, "yyyy/MM/dd"), new HashMap<String, Object>());
