...
public class RowPerPatientColumns {
	...
	public static MultiplePatientDataDefinitions getAnyId(String name) {
		...
		PatientIdentifierType archivingType = gp.getPatientIdentifier(GlobalPropertiesManagement.ARCHIVING_IDENTIFIER);
	...
	public static MultiplePatientDataDefinitions getArchivingId(String name) {
		PatientIdentifierType archivingId = gp.getPatientIdentifier(GlobalPropertiesManagement.ARCHIVING_IDENTIFIER);
	...
	public static MultiplePatientDataDefinitions getRwandaNationalID(String name) {
		PatientIdentifierType RwandaNationalID = gp.getPatientIdentifier(GlobalPropertiesManagement.RWANDA_NATIONAL_ID);
	...
	public static FirstStateOfPatient getFirstStateOfPatient(String name, Program program, ProgramWorkflow programWorkflow,
	        ResultFilter filter) {
	...
	public static MostRecentObservation getMostRecentASQ(String name, String dateFormat) {
		return getMostRecent(name, gp.getConcept(GlobalPropertiesManagement.ASQ_SCORE), dateFormat);
	}
	
	public static MostRecentObservation getMostRecentCondition(String name, String dateFormat) {
		return getMostRecent(name, gp.getConcept(GlobalPropertiesManagement.DISCHARGE_CONDITION), dateFormat);
	}
	
	public static MostRecentObservation getMostRecentSWA(String name, String dateFormat) {
		return getMostRecent(name, gp.getConcept(GlobalPropertiesManagement.SOCIAL_WORK_ASSESSMENT), dateFormat);
	}
	
	public static MostRecentObservation getMostRecentECDEDUC(String name, String dateFormat) {
		return getMostRecent(name, gp.getConcept(GlobalPropertiesManagement.ECD_EDUCATION), dateFormat);
	}
	...
	public static MostRecentObservation getMostRecentRespiratoryRate(String name, String dateFormat) {
		return getMostRecent(name, gp.getConcept(GlobalPropertiesManagement.RESPIRATORY_RATE), dateFormat);
	}
	
	public static MostRecentObservation getMostRecentIntervalGrowth(String name, String dateFormat) {
		return getMostRecent(name, gp.getConcept(GlobalPropertiesManagement.INTERVAL_GROWTH), dateFormat);
	}
	
	public static MostRecentObservation getMostRecentCodedIntGrowth(String name, String dateFormat) {
		return getMostRecent(name, gp.getConcept(GlobalPropertiesManagement.INTERVAL_GROWTH_CODED), dateFormat);
	}
	
	public static MostRecentObservation getMostRecentWtAgezscore(String name, String dateFormat) {
		return getMostRecent(name, gp.getConcept(GlobalPropertiesManagement.WTAGEZScore), dateFormat);
	}
	
	public static MostRecentObservation getMostRecentWtHeightzscore(String name, String dateFormat) {
		return getMostRecent(name, gp.getConcept(GlobalPropertiesManagement.WTHEIGHTZScore), dateFormat);
	}
	...
	public static AllMotherObservationValues getAllMotherCD4Values(String name, String dateFormat,
	        ResultFilter resultFilter, ResultFilter outputFilter) {
		return getAllMotherObservationValues(name, gp.getConcept(GlobalPropertiesManagement.CD4_TEST), dateFormat,
		    resultFilter, outputFilter);
	}
	
	public static AllMotherObservationValues getAllMotherWeightValues(String name, String dateFormat,
	        ResultFilter resultFilter, ResultFilter outputFilter) {
		return getAllMotherObservationValues(name, gp.getConcept(GlobalPropertiesManagement.WEIGHT_CONCEPT), dateFormat,
		    resultFilter, outputFilter);
	}
	...
	public static ObservationInMostRecentEncounter getSeizureInMostRecentEncounterOfType(String name,
	        List<EncounterType> encounterTypes, ObservationInMostRecentEncounterOfType observationInMostRecentEncounterOfType) {
		return getObservationInMostRecentEncounter(name, gp.getConcept(GlobalPropertiesManagement.SEIZURE_CONCEPT), null,
		    encounterTypes, null);
	...
	public static ObservationInMostRecentEncounterOfType getNextVisitMostRecentEncounterOfTheTypes(String name,
	        List<EncounterType> encounterTypes,
	        ObservationInMostRecentEncounterOfType observationInMostRecentEncounterOfType, ResultFilter resultFilter) {
		return getObservationInMostRecentEncounterOfTheTypes(name,
		    gp.getConcept(GlobalPropertiesManagement.RETURN_VISIT_DATE), encounterTypes, resultFilter);
	}
	...
	public static AllObservationValues getAllObservationValuesBeforeEndDate(String name, Concept concept, int minResults,
	        String dateFormat, ResultFilter resultFilter, ResultFilter outputFilter) {
	...
	public static AllObservationValues getAllObservationValuesAfterStartDateAndBeforeEndDate(String name, Concept concept,
	        String dateFormat, ResultFilter resultFilter, ResultFilter outputFilter) {
		AllObservationValues allObs = getAllObservationValues(name, concept, dateFormat, resultFilter, outputFilter);
	...
	public static ObservationInMostRecentEncounterOfType getObservationInMostRecentEncounterOfTheTypes(String name,
	        Concept concept, List<EncounterType> encounterTypes, ResultFilter resultFilter) {
	...
	public static AllMotherObservationValues getAllMotherObservationValues(String name, Concept concept, String dateFormat,
	        ResultFilter resultFilter, ResultFilter outputFilter) {
	...
	public static EvaluateMotherDefinition getDefinitionForOtherPersonObs(String name, PersonData person,
	        RowPerPatientData definition) {
	...
	public static DateOfObsAfterDateOfOtherDefinition getDateOfObsAfterDateOfOtherDefinition(String name, Concept concept,
	        Concept group, DateOfPatientData patientData) {
		DateOfObsAfterDateOfOtherDefinition dooadood = new DateOfObsAfterDateOfOtherDefinition();
		dooadood.setConcept(concept);
		dooadood.setName(name);
	...
	public static FirstDrugOrderStartedRestrictedByConceptSet getFirstDrugOrderStartedRestrictedByConceptSet(String name,
	        Concept conceptSet, String dateFormat) {
	...
	public static FirstDrugOrderStartedRestrictedByConceptSet getFirstDrugOrderStartedRestrictedByConceptSet(String name,
	        Concept conceptSet, String parameterName, String dateFormat) {
		FirstDrugOrderStartedRestrictedByConceptSet startDateDrugs = getFirstDrugOrderStartedRestrictedByConceptSet(name,
		    conceptSet);
	...
	public static ObsAfterPeriodOfTimeFromEncounterDate getObsAfterPeriodOfTimeFromEncounterDate(String name,
	        Concept question, List<Form> forms, List<EncounterType> encounterTypes, long timeDiff, ResultFilter filter) {
	...
	public static EnrolledInProgram getPatientProgramInfo(String name, Program program, String valueType,
	        ResultFilter filter, String dateFormat) {
	...
	public static AllObsValuesByRemovingUnwantedEncounters getAllObsValuesByRemovingUnwantedEncounters(String name,
	        Concept concept1, Concept concept2, List<Form> forms) {
	...
	public static AllTheOrdersetsWithIndicationOfConcept getNamesOfAllOrdersetsOfConcept(String name,
	        Concept indicationConcept) {
	...
	public static AllTheOrdersetsWithIndicationOfConcept getNamesOfAllOrdersetsOfConceptInPeriod(String name,
	        Concept indicationConcept) {
	...
	public static DateOfMostRecentObservationHavingCodedAnswer getDateOfMostRecentObservationHavingCodedAnswer(String name,
	        List<Concept> concepts, List<Concept> answers, String dateFormat) {
	...
	public static DateOfMostRecentObservationHavingCodedAnswer getDateOfMostRecentObservationHavingCodedAnswer(String name,
	        Concept concept, List<Concept> answers, String dateFormat) {
	...
	public static DateOfEarliestEnrolmentOfPrograms getDateOfEarliestEnrolmentOfPrograms(String name,
	        List<Program> programs, Date startDate, Date endDate, String dateFormat) {
	...
	public static DateOfEarliestEnrolmentOfPrograms getDateOfEarliestHIVProgramEnrolmentExcludePMTCTInfant(String name,
	        String dateFormat) {
	...
	public static MostRecentObservationInPeriod getMostRecentInPeriod(String name, Concept concept, Date startDate,
	        Date endDate, String dateFormat) {
	...
	public static MostRecentObservationInPeriod getMostRecentInperiodHavingCodedAnswers(String name, Concept question,
	        List<Concept> answers, Date startDate, Date endDate, String dateFormat) {
		MostRecentObservationInPeriod mostRecent = new MostRecentObservationInPeriod();
		mostRecent.setName(name);
	...
	public static DateOfMostRecentEncounterOfTypeInPeriod getMostRecentEncounterOfTypebyEnddate(String name,
	        List<EncounterType> encounterTypes, String dateFormat) {
