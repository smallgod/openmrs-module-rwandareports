...
public class SetupNCDsHMISReport extends SingleSetupReport implements SetupReport {
	...
	public void setup() throws Exception {
		...
		ReportDesign ncdDesign = Helper.createRowPerPatientXlsOverviewReportDesign(ncdRd, "NCDsHMISreport.xls",
	...
	public ReportDefinition createReportDefinition(String name, Properties properties) {
		...
		reportDefinition.setBaseCohortDefinition(location,
		    ParameterizableUtil.createParameterMappings("location=${location}"));
		reportDefinition.addDataSetDefinition(createCohortMonthlyBaseDataSet(),
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate},location=${location}"));
	...
	public void setUpProperties() {
		...
		otherNonCodedPulmonaryDiseases = Context.getConceptService()
		        .getConceptByUuid("0b8560c7-6eb9-4c92-a3b0-351f40fc12c0");
		...
		icd11OtherEndocrineAndMetabolicDisease = Context.getConceptService().getConceptByUuid(
		    "d9e647e7-5ebe-c47f-150f-6e7fe60600d6");
		...
		icd11OtherCardiovasculardiseases = Context.getConceptService().getConceptByUuid(
		    "332fb12f-d63b-938f-860d-dfdc7404624e");
		icd11Bronchitis = Context.getConceptService().getConceptByUuid("01d2b50e-75be-4e39-ac5d-61275db95da5");
		icd11OtheChronicrRespiratoryDisease = Context.getConceptService().getConceptByUuid(
		    "54660567-ffbe-ef9b-ef02-888bcd1c5c8c");
		...
		icd11OtherChronicKidneyDisease = Context.getConceptService()
		        .getConceptByUuid("8cb5f98a-977c-536b-68d0-a6df7eba5de4");
		icd11OtherChronicKidneyDisease2 = Context.getConceptService().getConceptByUuid(
		    "4403512f-4266-c7a6-e1df-ba84401f2022");
	...
	private void createCohortMonthlyIndicators(CohortIndicatorDataSetDefinition dsd) {
		...
		maleBetween0And39withAsthma.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newAsthma, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39withAsthma.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		maleBetween0And39withAsthma
		        .getSearches()
		        .put(
		            "3",
		            new Mapped<CohortDefinition>(
		                    newlyEnrolledInAsthma,
		                    ParameterizableUtil
		...
		CohortIndicator maleBetween0And39AsthmaNewCasePatientIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39AsthmaNewCasePatientIndicator", maleBetween0And39withAsthma,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn("A.N.M.039", "New Case Asthma Male", new Mapped(maleBetween0And39AsthmaNewCasePatientIndicator,
		        ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39withAsthma.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newAsthma, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39withAsthma.getSearches().put(
		...
		CohortIndicator femaleBetween0And39withAsthmaIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39withAsthmaIndicator", femaleBetween0And39withAsthma,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn("A.N.F.039", "New Case Asthma Female", new Mapped(femaleBetween0And39withAsthmaIndicator,
		        ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		malepatientsAbove40YearsWithAsthma.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newAsthma, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		malepatientsAbove40YearsWithAsthma.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientAbove40Years, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		malepatientsAbove40YearsWithAsthma
		        .getSearches()
		        .put(
		            "3",
		            new Mapped<CohortDefinition>(
		...
		CohortIndicator malepatientsAbove40YearsWithAsthmaIndicator = Indicators.newCohortIndicator(
		    "malepatientsAbove40YearsWithAsthmaIndicator", malepatientsAbove40YearsWithAsthma,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn("A.N.M.40", "New case Asthma Male above 40", new Mapped(malepatientsAbove40YearsWithAsthmaIndicator,
		        ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femalepatientsAbove40YearsWithAsthma.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newAsthma, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femalepatientsAbove40YearsWithAsthma.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientAbove40Years, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		femalepatientsAbove40YearsWithAsthma
		        .getSearches()
		        .put(
		            "3",
		            new Mapped<CohortDefinition>(
		...
		CohortIndicator femalepatientsAbove40YearsWithAsthmaIndicator = Indicators.newCohortIndicator(
		    "femalepatientsAbove40YearsWithAsthmaIndicator", femalepatientsAbove40YearsWithAsthma,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "A.N.F.40",
		    "New case Asthma Female above 40",
		    new Mapped(femalepatientsAbove40YearsWithAsthmaIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		// 1.1 Old case patient with Asthma
		
		SqlCohortDefinition oldAsthma = oldPatientWithNCDsDiagnosisObsByStartDateAndEndDateWithOutProgram(conceptAsthma,
		    combinedAsthma);
		...
		maleBetween0And39withAsthmaOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldAsthma, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39withAsthmaOldCasePatient.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		maleBetween0And39withAsthmaOldCasePatient
		        .getSearches()
		        .put(
		            "3",
		            new Mapped<CohortDefinition>(
		...
		CohortIndicator maleBetween0And39AsthmaOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39AsthmaOldCasePatientIndicator", maleBetween0And39withAsthmaOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn("A.O.M.039", "Old case Asthma Male", new Mapped(maleBetween0And39AsthmaOldCasePatientIndicator,
		        ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39withAsthmaOldCasePatient
		...
		femaleBetween0And39withAsthmaOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldAsthma, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39withAsthmaOldCasePatient.getSearches().put(
		...
		CohortIndicator femaleBetween0And39withAsthmaOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39withAsthmaOldCasePatientIndicator", femaleBetween0And39withAsthmaOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "A.O.F.039",
		    "Old case Asthma Female",
		    new Mapped(femaleBetween0And39withAsthmaOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		maleOldCasepatientsAbove40YearsWithAsthma.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldAsthma, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleOldCasepatientsAbove40YearsWithAsthma.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientAbove40Years, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		maleOldCasepatientsAbove40YearsWithAsthma
		        .getSearches()
		        .put(
		            "3",
		            new Mapped<CohortDefinition>(
		...
		CohortIndicator maleOldCasepatientsAbove40YearsWithAsthmaIndicator = Indicators.newCohortIndicator(
		    "maleOldCasepatientsAbove40YearsWithAsthmaIndicator", maleOldCasepatientsAbove40YearsWithAsthma,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "A.O.M.40",
		    "Old case Asthma Male above 40",
		    new Mapped(maleOldCasepatientsAbove40YearsWithAsthmaIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleOldCasepatientsAbove40YearsWithAsthma
		        .addParameter(new Parameter("effectiveDate", "effectiveDate", Date.class));
		...
		femaleOldCasepatientsAbove40YearsWithAsthma.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldAsthma, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleOldCasepatientsAbove40YearsWithAsthma.getSearches().put(
		...
		CohortIndicator femaleOldCasepatientsAbove40YearsWithAsthmaIndicator = Indicators.newCohortIndicator(
		    "femaleOldCasepatientsAbove40YearsWithAsthmaIndicator", femaleOldCasepatientsAbove40YearsWithAsthma,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "A.O.F.40",
		    "Old case Asthma Female above 40",
		    new Mapped(femaleOldCasepatientsAbove40YearsWithAsthmaIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		//        // 2.  New case patient with Bronchitis/Bronchite
		
		SqlCohortDefinition newBronchitis = newPatientWithNCDDiagnosisObsByStartDateAndEndDate(ICD11Concepts,
		    icd11Bronchitis);
		...
		maleBetween0And39Bronchitis.getSearches().put(
		    "1",
		...
		CohortIndicator maleBetween0And39BronchitisIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39BronchitisIndicator", maleBetween0And39Bronchitis,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn("B.N.M.039", "New case Bronchitis Male", new Mapped(maleBetween0And39BronchitisIndicator,
		        ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39Bronchitis.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newBronchitis, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39Bronchitis.getSearches().put(
		...
		CohortIndicator femaleBetween0And39BronchitisIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39BronchitisIndicator", femaleBetween0And39Bronchitis,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn("B.N.F.039", "New case Bronchitis Female", new Mapped(femaleBetween0And39BronchitisIndicator,
		        ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		SqlCohortDefinition oldBronchitis = oldPatientWithNCDDiagnosisObsByStartDateAndEndDate(ICD11Concepts,
		    icd11Bronchitis);
		...
		maleBetween0And39BronchitisOldCasePatient.getSearches().put(
		    "1",
		...
		CohortIndicator maleBetween0And39BronchitisOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39BronchitisOldCasePatientIndicator", maleBetween0And39BronchitisOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "B.O.M.039",
		    "Old case Bronchitis Male",
		    new Mapped(maleBetween0And39BronchitisOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39BronchitisOldCasePatient
		        .addParameter(new Parameter("effectiveDate", "effectiveDate", Date.class));
		...
		femaleBetween0And39BronchitisOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldBronchitis, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39BronchitisOldCasePatient.getSearches().put(
		...
		CohortIndicator femaleBetween0And39BronchitisOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39BronchitisOldCasePatientIndicator", femaleBetween0And39BronchitisOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "B.O.F.039",
		    "Old case Bronchitis Female",
		    new Mapped(femaleBetween0And39BronchitisOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		SqlCohortDefinition newOtherChronicRespiratoryDiseases = newPatientWithNCDsDiagnosisObsByStartDateAndEndDate(
		    conceptAsthma, combinedOtheChronicrRespiratoryDisease);
		...
		maleBetween0And39OtherChronicRespiratoryDiseases.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		maleBetween0And39OtherChronicRespiratoryDiseases.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newOtherChronicRespiratoryDiseases, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39OtherChronicRespiratoryDiseases.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		maleBetween0And39OtherChronicRespiratoryDiseases
		        .getSearches()
		        .put(
		            "3",
		            new Mapped<CohortDefinition>(
		...
		CohortIndicator maleBetween0And39OtherChronicRespiratoryDiseasesIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39OtherChronicRespiratoryDiseasesIndicator", maleBetween0And39OtherChronicRespiratoryDiseases,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OCR.N.M.039",
		    "New case Other Chronic respiratory diseases Male",
		    new Mapped(maleBetween0And39OtherChronicRespiratoryDiseasesIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39OtherChronicRespiratoryDiseases.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		femaleBetween0And39OtherChronicRespiratoryDiseases
		        .addParameter(new Parameter("onOrBefore", "onOrBefore", Date.class));
		femaleBetween0And39OtherChronicRespiratoryDiseases.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newOtherChronicRespiratoryDiseases, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39OtherChronicRespiratoryDiseases.getSearches().put(
		...
		CohortIndicator femaleBetween0And39OtherChronicRespiratoryDiseasesIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39OtherChronicRespiratoryDiseasesIndicator",
		    femaleBetween0And39OtherChronicRespiratoryDiseases,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OCR.N.F.039",
		    "New case Other Chronic respiratory diseases Female",
		    new Mapped(femaleBetween0And39OtherChronicRespiratoryDiseasesIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		// 40 +
		
		CompositionCohortDefinition malepatientsAbove40YearsWithOtherChronicRespiratoryDiseases = new CompositionCohortDefinition();
		malepatientsAbove40YearsWithOtherChronicRespiratoryDiseases
		        .setName("malepatientsAbove40YearsWithOtherChronicRespiratoryDiseases ");
		malepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("effectiveDate",
		        "effectiveDate", Date.class));
		malepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		malepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("endDate", "endDate",
		        Date.class));
		malepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		malepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		malepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newOtherChronicRespiratoryDiseases, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		malepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.getSearches().put(
		...
		malepatientsAbove40YearsWithOtherChronicRespiratoryDiseases
		        ...
		        .put(
		            ...
		            new Mapped<CohortDefinition>(
		                    ...
		                    ParameterizableUtil
		                            .createParameterMappings("enrolledOnOrAfter=${enrolledOnOrAfter},enrolledOnOrBefore=${enrolledOnOrBefore}")));
		malepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.getSearches().put("4",
		    new Mapped<CohortDefinition>(male, null));
		malepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.setCompositionString("1 and 2 and 3 and 4");
		
		CohortIndicator malepatientsAbove40YearsWithOtherChronicRespiratoryDiseasesIndicator = Indicators
		        .newCohortIndicator("malepatientsAbove40YearsWithOtherChronicRespiratoryDiseases Indicator",
		            malepatientsAbove40YearsWithOtherChronicRespiratoryDiseases,
		            ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OCR.N.M.40",
		    "New case Other Chronic respiratory diseases Male above 40",
		    new Mapped(malepatientsAbove40YearsWithOtherChronicRespiratoryDiseasesIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femalepatientsAbove40YearsWithOtherChronicRespiratoryDiseases
		        .setName("femalepatientsAbove40YearsWithOtherChronicRespiratoryDiseases ");
		femalepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("effectiveDate",
		        "effectiveDate", Date.class));
		femalepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		femalepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("endDate", "endDate",
		        Date.class));
		femalepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		femalepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		femalepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newOtherChronicRespiratoryDiseases, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femalepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.getSearches().put(
		...
		femalepatientsAbove40YearsWithOtherChronicRespiratoryDiseases
		        ...
		        .put(
		            ...
		            new Mapped<CohortDefinition>(
		                    ...
		                    ParameterizableUtil
		                            .createParameterMappings("enrolledOnOrAfter=${enrolledOnOrAfter},enrolledOnOrBefore=${enrolledOnOrBefore}")));
		femalepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.getSearches().put("4",
		    new Mapped<CohortDefinition>(male, null));
		femalepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.setCompositionString("1 and 2 and 3 and 4");
		
		CohortIndicator femalepatientsAbove40YearsWithOtherChronicRespiratoryDiseasesIndicator = Indicators
		        .newCohortIndicator("femalepatientsAbove40YearsWithOtherChronicRespiratoryDiseasesIndicator",
		            femalepatientsAbove40YearsWithOtherChronicRespiratoryDiseases,
		            ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OCR.N.F.40",
		    "New case Other Chronic respiratory diseases Female above 40",
		    new Mapped(femalepatientsAbove40YearsWithOtherChronicRespiratoryDiseasesIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		// IV.R. 2 Old case patient with Other Chronic respiratory diseases
		
		SqlCohortDefinition oldOtherChronicRespiratoryDiseases = oldPatientWithNCDsDiagnosisObsByStartDateAndEndDateWithOutProgram(
		    conceptAsthma, combinedOtheChronicrRespiratoryDisease);
		...
		maleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient
		        .setName("maleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient");
		maleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient.addParameter(new Parameter("effectiveDate",
		        "effectiveDate", Date.class));
		maleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		maleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient.addParameter(new Parameter("endDate", "endDate",
		        Date.class));
		maleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		maleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient.addParameter(new Parameter("onOrBefore",
		        "onOrBefore", Date.class));
		maleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldOtherChronicRespiratoryDiseases, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		...
		maleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient
		        ...
		        .put(
		            ...
		            new Mapped<CohortDefinition>(
		                    ...
		                    ParameterizableUtil
		                            .createParameterMappings("enrolledOnOrAfter=${enrolledOnOrAfter},enrolledOnOrBefore=${enrolledOnOrBefore}")));
		maleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient.getSearches().put("4",
		    new Mapped<CohortDefinition>(male, null));
		maleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient.setCompositionString("1 and 2 and 3 and 4");
		
		CohortIndicator maleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatientIndicator = Indicators
		        .newCohortIndicator("maleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatientIndicator",
		            maleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient,
		            ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OCR.O.M.039",
		    "Old case Other Chronic respiratory diseases Male",
		    new Mapped(maleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient
		        .setName("femaleBetween0And39AsthmaPersintentMildOldCasePatient");
		femaleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient.addParameter(new Parameter("effectiveDate",
		        "effectiveDate", Date.class));
		femaleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient.addParameter(new Parameter("startDate",
		        "startDate", Date.class));
		femaleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient.addParameter(new Parameter("endDate", "endDate",
		        Date.class));
		femaleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient.addParameter(new Parameter("onOrAfter",
		        "onOrAfter", Date.class));
		femaleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient.addParameter(new Parameter("onOrBefore",
		        "onOrBefore", Date.class));
		femaleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldOtherChronicRespiratoryDiseases, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient.getSearches().put(
		...
		femaleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient
		        ...
		        .put(
		            ...
		            new Mapped<CohortDefinition>(
		                    ...
		                    ParameterizableUtil
		                            .createParameterMappings("enrolledOnOrAfter=${enrolledOnOrAfter},enrolledOnOrBefore=${enrolledOnOrBefore}")));
		femaleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient.getSearches().put("4",
		    new Mapped<CohortDefinition>(male, null));
		femaleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient.setCompositionString("1 and 2 and 3 and 4");
		
		CohortIndicator femaleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatientIndicator = Indicators
		        .newCohortIndicator("femaleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatientIndicator",
		            femaleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatient,
		            ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OCR.O.F.039",
		    "Old case Other Chronic respiratory diseases Female",
		    new Mapped(femaleBetween0And39OtherChronicRespiratoryDiseasesOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		maleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases
		        .setName("maleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases");
		maleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("effectiveDate",
		        "effectiveDate", Date.class));
		maleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("startDate",
		        "startDate", Date.class));
		maleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("endDate", "endDate",
		        Date.class));
		maleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("onOrAfter",
		        "onOrAfter", Date.class));
		maleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("onOrBefore",
		        "onOrBefore", Date.class));
		maleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldOtherChronicRespiratoryDiseases, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.getSearches().put(
		...
		maleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases
		        ...
		        .put(
		            ...
		            new Mapped<CohortDefinition>(
		                    ...
		                    ParameterizableUtil
		                            .createParameterMappings("enrolledOnOrAfter=${enrolledOnOrAfter},enrolledOnOrBefore=${enrolledOnOrBefore}")));
		maleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.getSearches().put("4",
		    new Mapped<CohortDefinition>(male, null));
		maleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.setCompositionString("1 and 2 and 3 and 4");
		
		CohortIndicator maleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseasesIndicator = Indicators
		        .newCohortIndicator("maleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseasesIndicator",
		            maleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases,
		            ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OCR.O.M.40",
		    "Old case Other Chronic respiratory diseases Male above 40",
		    new Mapped(maleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseasesIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases
		        .setName("femaleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases");
		femaleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("effectiveDate",
		        "effectiveDate", Date.class));
		femaleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("startDate",
		        "startDate", Date.class));
		femaleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("endDate",
		        "endDate", Date.class));
		femaleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("onOrAfter",
		        "onOrAfter", Date.class));
		femaleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.addParameter(new Parameter("onOrBefore",
		        "onOrBefore", Date.class));
		femaleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldOtherChronicRespiratoryDiseases, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.getSearches().put(
		...
		femaleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases
		        ...
		        .put(
		            ...
		            new Mapped<CohortDefinition>(
		                    ...
		                    ParameterizableUtil
		                            .createParameterMappings("enrolledOnOrAfter=${enrolledOnOrAfter},enrolledOnOrBefore=${enrolledOnOrBefore}")));
		femaleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.getSearches().put("4",
		    new Mapped<CohortDefinition>(male, null));
		femaleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases.setCompositionString("1 and 2 and 3 and 4");
		
		CohortIndicator femaleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseasesIndicator = Indicators
		        .newCohortIndicator("femaleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseasesIndicator",
		            femaleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseases,
		            ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OCR.O.F.40",
		    "Old case Other Chronic respiratory diseases Female above 40",
		    new Mapped(femaleOldCasepatientsAbove40YearsWithOtherChronicRespiratoryDiseasesIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		// IV.R. 3 New case patient with Diabetes - Type 1
		
		SqlCohortDefinition newDiabetesTypeOne = newPatientWithNCDsDiagnosisObsByStartDateAndEndDate(conceptDiabetesType,
		    combinedDiabetesType1);
		...
		maleBetween0And39DiabetesTypeOne.getSearches().put(
		    "1",
		...
		CohortIndicator maleBetween0And39DiabetesTypeOneIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39DiabetesTypeOneIndicator", maleBetween0And39DiabetesTypeOne,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn("D1.N.M.039", "New case Diabetes - Type 1 Male", new Mapped(maleBetween0And39DiabetesTypeOneIndicator,
		        ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39DiabetesTypeOne.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newDiabetesTypeOne, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39DiabetesTypeOne.getSearches().put(
		...
		CohortIndicator femaleBetween0And39DiabetesTypeOneIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39DiabetesTypeOneIndicator", femaleBetween0And39DiabetesTypeOne,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "D1.N.F.039",
		    "New case Diabetes - Type 1 Female",
		    new Mapped(femaleBetween0And39DiabetesTypeOneIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		SqlCohortDefinition oldDiabetesTypeOne = oldPatientWithNCDsDiagnosisObsByStartDateAndEndDate(conceptDiabetesType,
		    combinedDiabetesType1);
		...
		maleBetween0And39DiabetesTypeOneOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		maleBetween0And39DiabetesTypeOneOldCasePatient.getSearches().put(
		    "1",
		...
		CohortIndicator maleBetween0And39DiabetesTypeOneOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39DiabetesTypeOneOldCasePatientIndicator", maleBetween0And39DiabetesTypeOneOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "D1.O.M.039",
		    "Old case Diabetes - Type 1 Male",
		    new Mapped(maleBetween0And39DiabetesTypeOneOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		CompositionCohortDefinition femaleBetween0And39DiabetesTypeOneOldCasePatient = new CompositionCohortDefinition();
		femaleBetween0And39DiabetesTypeOneOldCasePatient
		        .setName("femaleBetween0And39AsthmaPersintentModarateOldCasePatient");
		femaleBetween0And39DiabetesTypeOneOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		femaleBetween0And39DiabetesTypeOneOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldDiabetesTypeOne, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39DiabetesTypeOneOldCasePatient.getSearches().put(
		...
		CohortIndicator femaleBetween0And39DiabetesTypeOneOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39DiabetesTypeOneOldCasePatientIndicator", femaleBetween0And39DiabetesTypeOneOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "D1.O.F.039",
		    "Old case Diabetes - Type 1 Female",
		    new Mapped(femaleBetween0And39DiabetesTypeOneOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleOldCasepatientsAbove40YearsWithDiabetesTypeOne.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientAbove40Years, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		femaleOldCasepatientsAbove40YearsWithDiabetesTypeOne.getSearches()
		        .put("3", new Mapped<CohortDefinition>(male, null));
		...
		SqlCohortDefinition newDiabetesTypeTwo = newPatientWithNCDsDiagnosisObsByStartDateAndEndDate(conceptDiabetesType,
		    combinedDiabetesType2);
		...
		maleBetween0And39DiabetesTypeTwo.getSearches().put(
		    "1",
		...
		CohortIndicator maleBetween0And39DiabetesTypeTwoIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39DiabetesTypeTwoIndicator", maleBetween0And39DiabetesTypeTwo,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn("D2.N.M.039", "New case Diabetes - Type 2 Male", new Mapped(maleBetween0And39DiabetesTypeTwoIndicator,
		        ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39DiabetesTypeTwo.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newDiabetesTypeTwo, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39DiabetesTypeTwo.getSearches().put(
		...
		CohortIndicator femaleBetween0And39DiabetesTypeTwoIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39DiabetesTypeTwoIndicator", femaleBetween0And39DiabetesTypeTwo,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "D2.N.F.039",
		    "New case Diabetes - Type 2 Female",
		    new Mapped(femaleBetween0And39DiabetesTypeTwoIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		SqlCohortDefinition oldDiabetesTypeTwo = oldPatientWithNCDsDiagnosisObsByStartDateAndEndDate(conceptDiabetesType,
		    combinedDiabetesType2);
		...
		maleBetween0And39DiabetesTypeTwoOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		maleBetween0And39DiabetesTypeTwoOldCasePatient.getSearches().put(
		    "1",
		...
		CohortIndicator maleBetween0And39DiabetesTypeTwoOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39DiabetesTypeTwoOldCasePatientIndicator", maleBetween0And39DiabetesTypeTwoOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "D2.O.M.039",
		    "Old case Diabetes - Type 2 Male",
		    new Mapped(maleBetween0And39DiabetesTypeTwoOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39DiabetesTypeTwoOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		femaleBetween0And39DiabetesTypeTwoOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldDiabetesTypeTwo, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39DiabetesTypeTwoOldCasePatient.getSearches().put(
		...
		CohortIndicator femaleBetween0And39DiabetesTypeTwoOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39DiabetesTypeTwoOldCasePatientIndicator", femaleBetween0And39DiabetesTypeTwoOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "D2.O.F.039",
		    "Old case Diabetes - Type 2 Female",
		    new Mapped(femaleBetween0And39DiabetesTypeTwoOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleOldCasepatientsAbove40YearsWithDiabetesTypeTwo.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientAbove40Years, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		femaleOldCasepatientsAbove40YearsWithDiabetesTypeTwo.getSearches()
		        .put("3", new Mapped<CohortDefinition>(male, null));
		...
		SqlCohortDefinition newDiabetesGestational = newPatientWithNCDsDiagnosisObsByStartDateAndEndDate(
		    conceptDiabetesType, combinedDiabetesCongenital);
		...
		femaleBetween0And39DiabetesGestational.getSearches().put(
		    "1",
		...
		CohortIndicator femaleBetween0And39DiabetesGestationalIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39DiabetesGestationalIndicator", femaleBetween0And39DiabetesGestational,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "DG.N.F.039",
		    "New case Diabetes gestational Female",
		    new Mapped(femaleBetween0And39DiabetesGestationalIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		SqlCohortDefinition oldDiabetesGestational = oldPatientWithNCDsDiagnosisObsByStartDateAndEndDate(
		    conceptDiabetesType, combinedDiabetesCongenital);
		...
		femaleBetween0And39DiabetesGestationalOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		femaleBetween0And39DiabetesGestationalOldCasePatient
		        .addParameter(new Parameter("startDate", "startDate", Date.class));
		femaleBetween0And39DiabetesGestationalOldCasePatient.addParameter(new Parameter("endDate", "endDate", Date.class));
		femaleBetween0And39DiabetesGestationalOldCasePatient
		        .addParameter(new Parameter("onOrAfter", "onOrAfter", Date.class));
		femaleBetween0And39DiabetesGestationalOldCasePatient.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		femaleBetween0And39DiabetesGestationalOldCasePatient.getSearches().put(
		    "1",
		...
		femaleBetween0And39DiabetesGestationalOldCasePatient.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		femaleBetween0And39DiabetesGestationalOldCasePatient.getSearches()
		        .put("3", new Mapped<CohortDefinition>(male, null));
		femaleBetween0And39DiabetesGestationalOldCasePatient.setCompositionString("1 and 2 and (not 3)");
		
		CohortIndicator femaleBetween0And39DiabetesGestationalOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39DiabetesGestationalOldCasePatientIndicator",
		    femaleBetween0And39DiabetesGestationalOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "DG.O.F.039",
		    "Old case Diabetes gestational Female",
		    new Mapped(femaleBetween0And39DiabetesGestationalOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		maleBetween0And39WithHypertension.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithHypertension, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39WithHypertension.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		...
		CohortIndicator maleBetween0And39WithHypertensionIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithHypertensionIndicator", maleBetween0And39WithHypertension,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "H.N.M.039",
		    "New Case patients with Hypertension Male",
		    new Mapped(maleBetween0And39WithHypertensionIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39WithHypertension.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithHypertension, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithHypertension.getSearches().put(
		...
		CohortIndicator femaleBetween0And39WithHypertensionIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithHypertensionIndicator", femaleBetween0And39WithHypertension,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn("H.N.F.039", "New case Hypertension Female", new Mapped(femaleBetween0And39WithHypertensionIndicator,
		        ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		SqlCohortDefinition oldHypertension = oldPatientWithNCDDiagnosisObsByStartDateAndEndDateHypertension(
		    combinedHypertension, hypertensionProgram);
		...
		maleBetween0And39WithHypertensionOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		maleBetween0And39WithHypertensionOldCasePatient.getSearches().put(
		    "1",
		...
		CohortIndicator maleBetween0And39WithHypertensionOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithHypertensionOldCasePatientIndicator", maleBetween0And39WithHypertensionOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "H.O.M.039",
		    "Old case Hypertension Male",
		    new Mapped(maleBetween0And39WithHypertensionOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39WithHypertensionOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		femaleBetween0And39WithHypertensionOldCasePatient
		        .addParameter(new Parameter("onOrBefore", "onOrBefore", Date.class));
		femaleBetween0And39WithHypertensionOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldHypertension, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithHypertensionOldCasePatient.getSearches().put(
		...
		CohortIndicator femaleBetween0And39WithHypertensionOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithHypertensionOldCasePatientIndicator", femaleBetween0And39WithHypertensionOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "H.O.F.039",
		    "Old case Hypertension Female",
		    new Mapped(femaleBetween0And39WithHypertensionOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		SqlCohortDefinition newPatientWithcardiomyopathies = newPatientWithNCDsDiagnosisObsByStartDateAndEndDate(
		    conceptCardiomyophaties, combinedCardiomyophaties);
		...
		maleBetween0And39Withcardiomyopathies.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithcardiomyopathies, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39Withcardiomyopathies.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		...
		CohortIndicator maleBetween0And39WithcardiomyopathiesIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithcardiomyopathiesIndicator", maleBetween0And39Withcardiomyopathies,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "C.N.M.039",
		    "New Case patients with cardiomyopathies Male",
		    new Mapped(maleBetween0And39WithcardiomyopathiesIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39Withcardiomyopathies.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithcardiomyopathies, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39Withcardiomyopathies.getSearches().put(
		...
		CohortIndicator femaleBetween0And39WithcardiomyopathiesIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithcardiomyopathiesIndicator", femaleBetween0And39Withcardiomyopathies,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "C.N.F.039",
		    "New case cardiomyopathies Female",
		    new Mapped(femaleBetween0And39WithcardiomyopathiesIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		dsd.addColumn(
		    "C.N.M.40",
		    "New case cardiomyopathies Male above 40",
		...
		dsd.addColumn(
		    "C.N.F.40",
		    "New case cardiomyopathies Female above 40",
		...
		SqlCohortDefinition oldcardiomyopathies = oldPatientWithNCDsDiagnosisObsByStartDateAndEndDateWithOutProgram(
		    conceptCardiomyophaties, combinedCardiomyophaties);
		...
		maleBetween0And39WithcardiomyopathiesOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		maleBetween0And39WithcardiomyopathiesOldCasePatient
		        .addParameter(new Parameter("startDate", "startDate", Date.class));
		maleBetween0And39WithcardiomyopathiesOldCasePatient.addParameter(new Parameter("endDate", "endDate", Date.class));
		maleBetween0And39WithcardiomyopathiesOldCasePatient
		        .addParameter(new Parameter("onOrAfter", "onOrAfter", Date.class));
		maleBetween0And39WithcardiomyopathiesOldCasePatient.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		maleBetween0And39WithcardiomyopathiesOldCasePatient.getSearches().put(
		    "1",
		...
		CohortIndicator maleBetween0And39WithcardiomyopathiesOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithcardiomyopathiesOldCasePatientIndicator",
		    maleBetween0And39WithcardiomyopathiesOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "C.O.M.039",
		    "Old case cardiomyopathies Male",
		    new Mapped(maleBetween0And39WithcardiomyopathiesOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		CompositionCohortDefinition femaleBetween0And39WithcardiomyopathiesOldCasePatient = new CompositionCohortDefinition();
		femaleBetween0And39WithcardiomyopathiesOldCasePatient
		        .setName("femaleBetween0And39WithcardiomyopathiesOldCasePatient");
		femaleBetween0And39WithcardiomyopathiesOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		femaleBetween0And39WithcardiomyopathiesOldCasePatient.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		femaleBetween0And39WithcardiomyopathiesOldCasePatient.addParameter(new Parameter("endDate", "endDate", Date.class));
		femaleBetween0And39WithcardiomyopathiesOldCasePatient.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		femaleBetween0And39WithcardiomyopathiesOldCasePatient.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		femaleBetween0And39WithcardiomyopathiesOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldcardiomyopathies, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithcardiomyopathiesOldCasePatient.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		femaleBetween0And39WithcardiomyopathiesOldCasePatient.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		femaleBetween0And39WithcardiomyopathiesOldCasePatient.setCompositionString("1 and 2 and (not 3)");
		
		CohortIndicator femaleBetween0And39WithcardiomyopathiesOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithcardiomyopathiesOldCasePatientIndicator",
		    femaleBetween0And39WithcardiomyopathiesOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "C.O.F.039",
		    "Old case cardiomyopathies Female",
		    new Mapped(femaleBetween0And39WithcardiomyopathiesOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		dsd.addColumn(
		    "C.O.M.40",
		    "Old case cardiomyopathies Male above 40",
		...
		dsd.addColumn(
		    "C.O.F.40",
		    "Old case cardiomyopathies Female above 40",
		...
		SqlCohortDefinition newPatientWithpericardialDisease = newPatientWithNCDsDiagnosisObsByStartDateAndEndDate(
		    conceptPericardialDisease, combinedPericardialDisease);
		...
		maleBetween0And39WithpericardialDisease.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithpericardialDisease, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39WithpericardialDisease.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		...
		CohortIndicator maleBetween0And39WithpericardialDiseaseIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithpericardialDiseaseIndicator", maleBetween0And39WithpericardialDisease,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "PD.N.M.039",
		    "New Case patients with pericardialDisease Male",
		    new Mapped(maleBetween0And39WithpericardialDiseaseIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39WithpericardialDisease.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithpericardialDisease, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithpericardialDisease.getSearches().put(
		...
		CohortIndicator femaleBetween0And39WithpericardialDiseaseIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithpericardialDiseaseIndicator", femaleBetween0And39WithpericardialDisease,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "PD.N.F.039",
		    "New case pericardialDisease Female",
		    new Mapped(femaleBetween0And39WithpericardialDiseaseIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		dsd.addColumn(
		    "PD.N.M.40",
		    "New case pericardialDisease Male above 40",
		...
		dsd.addColumn(
		    "PD.N.F.40",
		    "New case pericardialDisease Female above 40",
		...
		SqlCohortDefinition oldpericardialDisease = oldPatientWithNCDsDiagnosisObsByStartDateAndEndDateWithOutProgram(
		    conceptPericardialDisease, combinedPericardialDisease);
		
		// 0-39
		
		CompositionCohortDefinition maleBetween0And39WithpericardialDiseaseOldCasePatient = new CompositionCohortDefinition();
		maleBetween0And39WithpericardialDiseaseOldCasePatient
		        .setName("maleBetween0And39WithpericardialDiseaseOldCasePatient");
		maleBetween0And39WithpericardialDiseaseOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		maleBetween0And39WithpericardialDiseaseOldCasePatient.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		maleBetween0And39WithpericardialDiseaseOldCasePatient.addParameter(new Parameter("endDate", "endDate", Date.class));
		maleBetween0And39WithpericardialDiseaseOldCasePatient.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		maleBetween0And39WithpericardialDiseaseOldCasePatient.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		maleBetween0And39WithpericardialDiseaseOldCasePatient.getSearches().put(
		    "1",
		...
		maleBetween0And39WithpericardialDiseaseOldCasePatient.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		maleBetween0And39WithpericardialDiseaseOldCasePatient.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		maleBetween0And39WithpericardialDiseaseOldCasePatient.setCompositionString("1 and 2 and 3");
		
		CohortIndicator maleBetween0And39WithpericardialDiseaseOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithpericardialDiseaseOldCasePatientIndicator",
		    maleBetween0And39WithpericardialDiseaseOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "PD.O.M.039",
		    "Old case pericardialDisease Male",
		    new Mapped(maleBetween0And39WithpericardialDiseaseOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		CompositionCohortDefinition femaleBetween0And39WithpericardialDiseaseOldCasePatient = new CompositionCohortDefinition();
		femaleBetween0And39WithpericardialDiseaseOldCasePatient
		        .setName("femaleBetween0And39WithpericardialDiseaseOldCasePatient");
		femaleBetween0And39WithpericardialDiseaseOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		femaleBetween0And39WithpericardialDiseaseOldCasePatient.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		femaleBetween0And39WithpericardialDiseaseOldCasePatient
		        .addParameter(new Parameter("endDate", "endDate", Date.class));
		femaleBetween0And39WithpericardialDiseaseOldCasePatient.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		femaleBetween0And39WithpericardialDiseaseOldCasePatient.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		femaleBetween0And39WithpericardialDiseaseOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldpericardialDisease, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithpericardialDiseaseOldCasePatient.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		femaleBetween0And39WithpericardialDiseaseOldCasePatient.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		femaleBetween0And39WithpericardialDiseaseOldCasePatient.setCompositionString("1 and 2 and (not 3)");
		
		CohortIndicator femaleBetween0And39WithpericardialDiseaseOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithpericardialDiseaseOldCasePatientIndicator",
		    femaleBetween0And39WithpericardialDiseaseOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "PD.O.F.039",
		    "Old case pericardialDisease Female",
		    new Mapped(femaleBetween0And39WithpericardialDiseaseOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		dsd.addColumn(
		    "PD.O.M.40",
		    "Old case pericardialDisease Male above 40",
		...
		dsd.addColumn(
		    "PD.O.F.40",
		    "Old case pericardialDisease Female above 40",
		...
		SqlCohortDefinition newPatientWithHeartFailure = newPatientWithNCDsDiagnosisObsByStartDateAndEndDate(
		    conceptHeartFailure, combinedHeartFailure);
		...
		maleBetween0And39WithHeartFailure.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithHeartFailure, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39WithHeartFailure.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		...
		CohortIndicator maleBetween0And39WithHeartFailureIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithHeartFailureIndicator", maleBetween0And39WithHeartFailure,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "HF.N.M.039",
		    "New Case patients with heartFailure Male",
		    new Mapped(maleBetween0And39WithHeartFailureIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39WithHeartFailure.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithHeartFailure, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithHeartFailure.getSearches().put(
		...
		CohortIndicator femaleBetween0And39WithHeartFailureIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithHeartFailureIndicator", femaleBetween0And39WithHeartFailure,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn("HF.N.F.039", "New case heartFailure Female", new Mapped(femaleBetween0And39WithHeartFailureIndicator,
		        ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		dsd.addColumn(
		    "HF.N.M.40",
		    "New case heartFailure Male above 40",
		...
		dsd.addColumn(
		    "HF.N.F.40",
		    "New case heartFailure Female above 40",
		...
		SqlCohortDefinition oldheartFailure = oldPatientWithNCDsDiagnosisObsByStartDateAndEndDate(conceptHeartFailure,
		    combinedHeartFailure);
		...
		maleBetween0And39WithHeartFailureOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		maleBetween0And39WithHeartFailureOldCasePatient.getSearches().put(
		    "1",
		...
		CohortIndicator maleBetween0And39WithHeartFailureOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithHeartFailureOldCasePatientIndicator", maleBetween0And39WithHeartFailureOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "HF.O.M.039",
		    "Old case heartFailure Male",
		    new Mapped(maleBetween0And39WithHeartFailureOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39WithHeartFailureOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		femaleBetween0And39WithHeartFailureOldCasePatient
		        .addParameter(new Parameter("onOrBefore", "onOrBefore", Date.class));
		femaleBetween0And39WithHeartFailureOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldheartFailure, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithHeartFailureOldCasePatient.getSearches().put(
		...
		CohortIndicator femaleBetween0And39WithHeartFailureOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithHeartFailureOldCasePatientIndicator", femaleBetween0And39WithHeartFailureOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "HF.O.F.039",
		    "Old case heartFailure Female",
		    new Mapped(femaleBetween0And39WithHeartFailureOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		dsd.addColumn(
		    "HF.O.M.40",
		    "Old case heartFailure Male above 40",
		...
		dsd.addColumn(
		    "HF.O.F.40",
		    "Old case heartFailure Female above 40",
		    new Mapped(femaleOldCasepatientsAbove40YearsWithHeartFailureIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		// New patients with Stroke
		
		SqlCohortDefinition newPatientWithStroke = newPatientWithNCDsDiagnosisObsByStartDateAndEndDate(conceptStroke,
		    combinedStroke);
		...
		maleBetween0And39WithStroke.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithStroke, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39WithStroke.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		...
		CohortIndicator maleBetween0And39WithStrokeIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithStrokeIndicator", maleBetween0And39WithStroke,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn("ST.N.M.039", "New Case patients with Stroke Male", new Mapped(maleBetween0And39WithStrokeIndicator,
		        ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39WithStroke.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithStroke, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithStroke.getSearches().put(
		...
		CohortIndicator femaleBetween0And39WithStrokeIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithStrokeIndicator", femaleBetween0And39WithStroke,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn("ST.N.F.039", "New case Stroke Female", new Mapped(femaleBetween0And39WithStrokeIndicator,
		        ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		malepatientsAbove40YearsWithStroke.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithStroke, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		malepatientsAbove40YearsWithStroke.getSearches().put(
		...
		CohortIndicator malepatientsAbove40YearsWithStrokeIndicator = Indicators.newCohortIndicator(
		    "malepatientsAbove40YearsWithStrokeIndicator", malepatientsAbove40YearsWithStroke,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn("ST.N.M.40", "New case Stroke Male above 40", new Mapped(malepatientsAbove40YearsWithStrokeIndicator,
		        ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femalepatientsAbove40YearsWithStroke.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithStroke, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femalepatientsAbove40YearsWithStroke.getSearches().put(
		...
		CohortIndicator femalepatientsAbove40YearsWithStrokeIndicator = Indicators.newCohortIndicator(
		    "femalepatientsAbove40YearsWithStrokeIndicator", femalepatientsAbove40YearsWithStroke,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "ST.N.F.40",
		    "New case Stroke Female above 40",
		    new Mapped(femalepatientsAbove40YearsWithStrokeIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		// IV.R. 4 Old case patient with Stroke
		
		SqlCohortDefinition oldStroke = oldPatientWithNCDsDiagnosisObsByStartDateAndEndDateWithOutProgram(conceptStroke,
		    combinedStroke);
		...
		maleBetween0And39WithStrokeOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldStroke, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39WithStrokeOldCasePatient.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		...
		CohortIndicator maleBetween0And39WithStrokeOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithStrokeOldCasePatientIndicator", maleBetween0And39WithStrokeOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn("ST.O.M.039", "Old case Stroke Male", new Mapped(maleBetween0And39WithStrokeOldCasePatientIndicator,
		        ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39WithStrokeOldCasePatient
		        .addParameter(new Parameter("effectiveDate", "effectiveDate", Date.class));
		...
		femaleBetween0And39WithStrokeOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldStroke, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithStrokeOldCasePatient.getSearches().put(
		...
		CohortIndicator femaleBetween0And39WithStrokeOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithStrokeOldCasePatientIndicator", femaleBetween0And39WithStrokeOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "ST.O.F.039",
		    "Old case Stroke Female",
		    new Mapped(femaleBetween0And39WithStrokeOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		maleOldCasepatientsAbove40YearsWithStroke.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldStroke, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleOldCasepatientsAbove40YearsWithStroke.getSearches().put(
		...
		CohortIndicator maleOldCasepatientsAbove40YearsWithStrokeIndicator = Indicators.newCohortIndicator(
		    "maleOldCasepatientsAbove40YearsWithStrokeIndicator", maleOldCasepatientsAbove40YearsWithStroke,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "ST.O.M.40",
		    "Old case Stroke Male above 40",
		    new Mapped(maleOldCasepatientsAbove40YearsWithStrokeIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleOldCasepatientsAbove40YearsWithStroke
		        .addParameter(new Parameter("effectiveDate", "effectiveDate", Date.class));
		...
		femaleOldCasepatientsAbove40YearsWithStroke.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldStroke, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleOldCasepatientsAbove40YearsWithStroke.getSearches().put(
		...
		CohortIndicator femaleOldCasepatientsAbove40YearsWithStrokeIndicator = Indicators.newCohortIndicator(
		    "femaleOldCasepatientsAbove40YearsWithStrokeIndicator", femaleOldCasepatientsAbove40YearsWithStroke,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "ST.O.F.40",
		    "Old case Stroke Female above 40",
		    new Mapped(femaleOldCasepatientsAbove40YearsWithStrokeIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		// New patients with Rheumatic Heart Disease
		SqlCohortDefinition newPatientWithRheumaticHeartDisease = newPatientWithNCDsDiagnosisObsByStartDateAndEndDate(
		    conceptRheumaticHeart, combinedRheumaticHeart);
		...
		maleBetween0And39WithRheumaticHeartDisease.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithRheumaticHeartDisease, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39WithRheumaticHeartDisease.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		...
		CohortIndicator maleBetween0And39WithRheumaticHeartDiseaseIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithRheumaticHeartDiseaseIndicator", maleBetween0And39WithRheumaticHeartDisease,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "RH.N.M.039",
		    "New Case patients with RheumaticHeartDisease Male",
		    new Mapped(maleBetween0And39WithRheumaticHeartDiseaseIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39WithRheumaticHeartDisease
		        .addParameter(new Parameter("effectiveDate", "effectiveDate", Date.class));
		...
		femaleBetween0And39WithRheumaticHeartDisease.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithRheumaticHeartDisease, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithRheumaticHeartDisease.getSearches().put(
		...
		CohortIndicator femaleBetween0And39WithRheumaticHeartDiseaseIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithRheumaticHeartDiseaseIndicator", femaleBetween0And39WithRheumaticHeartDisease,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "RH.N.F.039",
		    "New case RheumaticHeartDisease Female",
		    new Mapped(femaleBetween0And39WithRheumaticHeartDiseaseIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		dsd.addColumn(
		    "RH.N.M.40",
		    "New case RheumaticHeartDisease Male above 40",
		...
		dsd.addColumn(
		    "RH.N.F.40",
		    "New case RheumaticHeartDisease Female above 40",
		...
		SqlCohortDefinition oldRheumaticHeartDisease = oldPatientWithNCDsDiagnosisObsByStartDateAndEndDateWithOutProgram(
		    conceptRheumaticHeart, combinedRheumaticHeart);
		
		// 0-39
		
		CompositionCohortDefinition maleBetween0And39WithRheumaticHeartDiseaseOldCasePatient = new CompositionCohortDefinition();
		maleBetween0And39WithRheumaticHeartDiseaseOldCasePatient
		        .setName("maleBetween0And39WithRheumaticHeartDiseaseOldCasePatient");
		maleBetween0And39WithRheumaticHeartDiseaseOldCasePatient.addParameter(new Parameter("effectiveDate",
		        "effectiveDate", Date.class));
		maleBetween0And39WithRheumaticHeartDiseaseOldCasePatient.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		maleBetween0And39WithRheumaticHeartDiseaseOldCasePatient
		        .addParameter(new Parameter("endDate", "endDate", Date.class));
		maleBetween0And39WithRheumaticHeartDiseaseOldCasePatient.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		maleBetween0And39WithRheumaticHeartDiseaseOldCasePatient.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		maleBetween0And39WithRheumaticHeartDiseaseOldCasePatient.getSearches().put(
		    "1",
		...
		maleBetween0And39WithRheumaticHeartDiseaseOldCasePatient.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		maleBetween0And39WithRheumaticHeartDiseaseOldCasePatient.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		maleBetween0And39WithRheumaticHeartDiseaseOldCasePatient.setCompositionString("1 and 2 and 3");
		
		CohortIndicator maleBetween0And39WithRheumaticHeartDiseaseOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithRheumaticHeartDiseaseOldCasePatientIndicator",
		    maleBetween0And39WithRheumaticHeartDiseaseOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "RH.O.M.039",
		    "Old case RheumaticHeartDisease Male",
		    new Mapped(maleBetween0And39WithRheumaticHeartDiseaseOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		CompositionCohortDefinition femaleBetween0And39WithRheumaticHeartDiseaseOldCasePatient = new CompositionCohortDefinition();
		femaleBetween0And39WithRheumaticHeartDiseaseOldCasePatient
		        .setName("femaleBetween0And39WithRheumaticHeartDiseaseOldCasePatient");
		femaleBetween0And39WithRheumaticHeartDiseaseOldCasePatient.addParameter(new Parameter("effectiveDate",
		        "effectiveDate", Date.class));
		femaleBetween0And39WithRheumaticHeartDiseaseOldCasePatient.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		femaleBetween0And39WithRheumaticHeartDiseaseOldCasePatient.addParameter(new Parameter("endDate", "endDate",
		        Date.class));
		femaleBetween0And39WithRheumaticHeartDiseaseOldCasePatient.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		femaleBetween0And39WithRheumaticHeartDiseaseOldCasePatient.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		femaleBetween0And39WithRheumaticHeartDiseaseOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldRheumaticHeartDisease, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithRheumaticHeartDiseaseOldCasePatient.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		femaleBetween0And39WithRheumaticHeartDiseaseOldCasePatient.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		femaleBetween0And39WithRheumaticHeartDiseaseOldCasePatient.setCompositionString("1 and 2 and (not 3)");
		
		CohortIndicator femaleBetween0And39WithRheumaticHeartDiseaseOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithRheumaticHeartDiseaseOldCasePatientIndicator",
		    femaleBetween0And39WithRheumaticHeartDiseaseOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "RH.O.F.039",
		    "Old case RheumaticHeartDisease Female",
		    new Mapped(femaleBetween0And39WithRheumaticHeartDiseaseOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		dsd.addColumn(
		    "RH.O.M.40",
		    "Old case RheumaticHeartDisease Male above 40",
		...
		dsd.addColumn(
		    "RH.O.F.40",
		    "Old case RheumaticHeartDisease Female above 40",
		...
		SqlCohortDefinition newPatientWithCongenitalHeartDisease = newPatientWithNCDsDiagnosisObsByStartDateAndEndDate(
		    conceptCongenitalHeart, combinedCongenitalHeart);
		...
		maleBetween0And39WithCongenitalHeartDisease
		        .addParameter(new Parameter("effectiveDate", "effectiveDate", Date.class));
		...
		maleBetween0And39WithCongenitalHeartDisease.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithCongenitalHeartDisease, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39WithCongenitalHeartDisease.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		...
		CohortIndicator maleBetween0And39WithCongenitalHeartDiseaseIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithCongenitalHeartDiseaseIndicator", maleBetween0And39WithCongenitalHeartDisease,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "CH.N.M.039",
		    "New Case patients with CongenitalHeartDisease Male",
		    new Mapped(maleBetween0And39WithCongenitalHeartDiseaseIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39WithCongenitalHeartDisease.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		femaleBetween0And39WithCongenitalHeartDisease.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithCongenitalHeartDisease, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithCongenitalHeartDisease.getSearches().put(
		...
		CohortIndicator femaleBetween0And39WithCongenitalHeartDiseaseIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithCongenitalHeartDiseaseIndicator", femaleBetween0And39WithCongenitalHeartDisease,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "CH.N.F.039",
		    "New case CongenitalHeartDisease Female",
		    new Mapped(femaleBetween0And39WithCongenitalHeartDiseaseIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		dsd.addColumn(
		    "CH.N.M.40",
		    "New case CongenitalHeartDisease Male above 40",
		...
		femalepatientsAbove40YearsWithCongenitalHeartDisease.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientAbove40Years, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		femalepatientsAbove40YearsWithCongenitalHeartDisease.getSearches()
		        .put("3", new Mapped<CohortDefinition>(male, null));
		...
		dsd.addColumn(
		    "CH.N.F.40",
		    "New case CongenitalHeartDisease Female above 40",
		...
		SqlCohortDefinition oldCongenitalHeartDisease = oldPatientWithNCDsDiagnosisObsByStartDateAndEndDateWithOutProgram(
		    conceptCongenitalHeart, combinedCongenitalHeart);
		
		// 0-39
		
		CompositionCohortDefinition maleBetween0And39WithCongenitalHeartDiseaseOldCasePatient = new CompositionCohortDefinition();
		maleBetween0And39WithCongenitalHeartDiseaseOldCasePatient
		        .setName("maleBetween0And39WithCongenitalHeartDiseaseOldCasePatient");
		maleBetween0And39WithCongenitalHeartDiseaseOldCasePatient.addParameter(new Parameter("effectiveDate",
		        "effectiveDate", Date.class));
		maleBetween0And39WithCongenitalHeartDiseaseOldCasePatient.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		maleBetween0And39WithCongenitalHeartDiseaseOldCasePatient.addParameter(new Parameter("endDate", "endDate",
		        Date.class));
		maleBetween0And39WithCongenitalHeartDiseaseOldCasePatient.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		maleBetween0And39WithCongenitalHeartDiseaseOldCasePatient.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		maleBetween0And39WithCongenitalHeartDiseaseOldCasePatient.getSearches().put(
		    "1",
		...
		maleBetween0And39WithCongenitalHeartDiseaseOldCasePatient.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		maleBetween0And39WithCongenitalHeartDiseaseOldCasePatient.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		maleBetween0And39WithCongenitalHeartDiseaseOldCasePatient.setCompositionString("1 and 2 and 3");
		
		CohortIndicator maleBetween0And39WithCongenitalHeartDiseaseOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithCongenitalHeartDiseaseOldCasePatientIndicator",
		    maleBetween0And39WithCongenitalHeartDiseaseOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "CH.O.M.039",
		    "Old case CongenitalHeartDisease Male",
		    new Mapped(maleBetween0And39WithCongenitalHeartDiseaseOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		CompositionCohortDefinition femaleBetween0And39WithCongenitalHeartDiseaseOldCasePatient = new CompositionCohortDefinition();
		femaleBetween0And39WithCongenitalHeartDiseaseOldCasePatient
		        .setName("femaleBetween0And39WithCongenitalHeartDiseaseOldCasePatient");
		femaleBetween0And39WithCongenitalHeartDiseaseOldCasePatient.addParameter(new Parameter("effectiveDate",
		        "effectiveDate", Date.class));
		femaleBetween0And39WithCongenitalHeartDiseaseOldCasePatient.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		femaleBetween0And39WithCongenitalHeartDiseaseOldCasePatient.addParameter(new Parameter("endDate", "endDate",
		        Date.class));
		femaleBetween0And39WithCongenitalHeartDiseaseOldCasePatient.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		femaleBetween0And39WithCongenitalHeartDiseaseOldCasePatient.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		femaleBetween0And39WithCongenitalHeartDiseaseOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldCongenitalHeartDisease, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithCongenitalHeartDiseaseOldCasePatient.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		femaleBetween0And39WithCongenitalHeartDiseaseOldCasePatient.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		femaleBetween0And39WithCongenitalHeartDiseaseOldCasePatient.setCompositionString("1 and 2 and (not 3)");
		
		CohortIndicator femaleBetween0And39WithCongenitalHeartDiseaseOldCasePatientIndicator = Indicators
		        .newCohortIndicator("femaleBetween0And39WithCongenitalHeartDiseaseOldCasePatientIndicator",
		            femaleBetween0And39WithCongenitalHeartDiseaseOldCasePatient,
		            ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "CH.O.F.039",
		    "Old case CongenitalHeartDisease Female",
		    new Mapped(femaleBetween0And39WithCongenitalHeartDiseaseOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		dsd.addColumn(
		    "CH.O.M.40",
		    "Old case CongenitalHeartDisease Male above 40",
		...
		dsd.addColumn(
		    "CH.O.F.40",
		    "Old case CongenitalHeartDisease Female above 40",
		...
		SqlCohortDefinition newPatientWithOtherCardiovasculardiseases = newPatientWithNCDsDiagnosisObsByStartDateAndEndDate(
		    conceptOtherCardiovasculardiseases, combinedOtherCardiovasculardiseases);
		...
		maleBetween0And39WithOtherCardiovasculardiseases.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		maleBetween0And39WithOtherCardiovasculardiseases.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithOtherCardiovasculardiseases, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39WithOtherCardiovasculardiseases.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		...
		CohortIndicator maleBetween0And39WithOtherCardiovasculardiseasesIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithOtherCardiovasculardiseasesIndicator", maleBetween0And39WithOtherCardiovasculardiseases,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OC.N.M.039",
		    "New Case patients with OtherCardiovasculardiseases Male",
		    new Mapped(maleBetween0And39WithOtherCardiovasculardiseasesIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39WithOtherCardiovasculardiseases.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		femaleBetween0And39WithOtherCardiovasculardiseases
		        .addParameter(new Parameter("onOrBefore", "onOrBefore", Date.class));
		femaleBetween0And39WithOtherCardiovasculardiseases.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithOtherCardiovasculardiseases, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithOtherCardiovasculardiseases.getSearches().put(
		...
		CohortIndicator femaleBetween0And39WithOtherCardiovasculardiseasesIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithOtherCardiovasculardiseasesIndicator",
		    femaleBetween0And39WithOtherCardiovasculardiseases,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OC.N.F.039",
		    "New case OtherCardiovasculardiseases Female",
		    new Mapped(femaleBetween0And39WithOtherCardiovasculardiseasesIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		dsd.addColumn(
		    "OC.N.M.40",
		    "New case OtherCardiovasculardiseases Male above 40",
		...
		dsd.addColumn(
		    "OC.N.F.40",
		    "New case OtherCardiovasculardiseases Female above 40",
		...
		SqlCohortDefinition oldOtherCardiovasculardiseases = oldPatientWithNCDsDiagnosisObsByStartDateAndEndDateWithOutProgram(
		    conceptOtherCardiovasculardiseases, combinedOtherCardiovasculardiseases);
		...
		maleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient
		        .setName("maleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient");
		maleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient.addParameter(new Parameter("effectiveDate",
		        "effectiveDate", Date.class));
		maleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		maleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient.addParameter(new Parameter("endDate", "endDate",
		        Date.class));
		maleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		maleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient.addParameter(new Parameter("onOrBefore",
		        "onOrBefore", Date.class));
		maleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient.getSearches().put(
		    "1",
		...
		maleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		maleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		maleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient.setCompositionString("1 and 2 and 3");
		
		CohortIndicator maleBetween0And39WithOtherCardiovasculardiseasesOldCasePatientIndicator = Indicators
		        .newCohortIndicator("maleBetween0And39WithOtherCardiovasculardiseasesOldCasePatientIndicator",
		            maleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient,
		            ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OC.O.M.039",
		    "Old case OtherCardiovasculardiseases Male",
		    new Mapped(maleBetween0And39WithOtherCardiovasculardiseasesOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient
		        .setName("femaleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient");
		femaleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient.addParameter(new Parameter("effectiveDate",
		        "effectiveDate", Date.class));
		femaleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient.addParameter(new Parameter("startDate",
		        "startDate", Date.class));
		femaleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient.addParameter(new Parameter("endDate", "endDate",
		        Date.class));
		femaleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient.addParameter(new Parameter("onOrAfter",
		        "onOrAfter", Date.class));
		femaleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient.addParameter(new Parameter("onOrBefore",
		        "onOrBefore", Date.class));
		femaleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldOtherCardiovasculardiseases, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		femaleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		femaleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient.setCompositionString("1 and 2 and (not 3)");
		
		CohortIndicator femaleBetween0And39WithOtherCardiovasculardiseasesOldCasePatientIndicator = Indicators
		        .newCohortIndicator("femaleBetween0And39WithOtherCardiovasculardiseasesOldCasePatientIndicator",
		            femaleBetween0And39WithOtherCardiovasculardiseasesOldCasePatient,
		            ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OC.O.F.039",
		    "Old case OtherCardiovasculardiseases Female",
		    new Mapped(femaleBetween0And39WithOtherCardiovasculardiseasesOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		dsd.addColumn(
		    "OC.O.M.40",
		    "Old case OtherCardiovasculardiseases Male above 40",
		...
		dsd.addColumn(
		    "OC.O.F.40",
		    "Old case OtherCardiovasculardiseases Female above 40",
		...
		SqlCohortDefinition newPatientWithDeepVeinThrombosis = newPatientWithNCDDiagnosisObsByStartDateAndEndDate(
		    ICD11Concepts, icd11Deepveinusthrombosis);
		...
		maleBetween0And39WithDeepVeinThrombosis.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithDeepVeinThrombosis, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39WithDeepVeinThrombosis.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		...
		CohortIndicator maleBetween0And39WithDeepVeinThrombosisIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithDeepVeinThrombosisIndicator", maleBetween0And39WithDeepVeinThrombosis,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "DVT.N.M.039",
		    "New Case patients with DeepVeinThrombosis Male",
		    new Mapped(maleBetween0And39WithDeepVeinThrombosisIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39WithDeepVeinThrombosis.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithDeepVeinThrombosis, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithDeepVeinThrombosis.getSearches().put(
		...
		CohortIndicator femaleBetween0And39WithDeepVeinThrombosisIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithDeepVeinThrombosisIndicator", femaleBetween0And39WithDeepVeinThrombosis,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "DVT.N.F.039",
		    "New case DeepVeinThrombosis Female",
		    new Mapped(femaleBetween0And39WithDeepVeinThrombosisIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		malepatientsAbove40YearsWithDeepVeinThrombosis.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		malepatientsAbove40YearsWithDeepVeinThrombosis.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithDeepVeinThrombosis, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		malepatientsAbove40YearsWithDeepVeinThrombosis.getSearches().put(
		...
		CohortIndicator malepatientsAbove40YearsWithDeepVeinThrombosisIndicator = Indicators.newCohortIndicator(
		    "malepatientsAbove40YearsWithDeepVeinThrombosisIndicator", malepatientsAbove40YearsWithDeepVeinThrombosis,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "DVT.N.M.40",
		    "New case DeepVeinThrombosis Male above 40",
		    new Mapped(malepatientsAbove40YearsWithDeepVeinThrombosisIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femalepatientsAbove40YearsWithDeepVeinThrombosis.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		femalepatientsAbove40YearsWithDeepVeinThrombosis.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithDeepVeinThrombosis, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femalepatientsAbove40YearsWithDeepVeinThrombosis.getSearches().put(
		...
		CohortIndicator femalepatientsAbove40YearsWithDeepVeinThrombosisIndicator = Indicators.newCohortIndicator(
		    "femalepatientsAbove40YearsWithDeepVeinThrombosisIndicator", femalepatientsAbove40YearsWithDeepVeinThrombosis,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "DVT.N.F.40",
		    "New case DeepVeinThrombosis Female above 40",
		    new Mapped(femalepatientsAbove40YearsWithDeepVeinThrombosisIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		// IV.R. 4 Old case patient with DeepVeinThrombosis
		
		SqlCohortDefinition oldDeepVeinThrombosis = oldPatientWithNCDDiagnosisObsByStartDateAndEndDate(ICD11Concepts,
		    icd11Deepveinusthrombosis);
		
		// 0-39
		
		CompositionCohortDefinition maleBetween0And39WithDeepVeinThrombosisOldCasePatient = new CompositionCohortDefinition();
		maleBetween0And39WithDeepVeinThrombosisOldCasePatient
		        .setName("maleBetween0And39WithDeepVeinThrombosisOldCasePatient");
		maleBetween0And39WithDeepVeinThrombosisOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		maleBetween0And39WithDeepVeinThrombosisOldCasePatient.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		maleBetween0And39WithDeepVeinThrombosisOldCasePatient.addParameter(new Parameter("endDate", "endDate", Date.class));
		maleBetween0And39WithDeepVeinThrombosisOldCasePatient.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		maleBetween0And39WithDeepVeinThrombosisOldCasePatient.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		maleBetween0And39WithDeepVeinThrombosisOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldDeepVeinThrombosis, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39WithDeepVeinThrombosisOldCasePatient.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		maleBetween0And39WithDeepVeinThrombosisOldCasePatient.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		maleBetween0And39WithDeepVeinThrombosisOldCasePatient.setCompositionString("1 and 2 and 3");
		
		CohortIndicator maleBetween0And39WithDeepVeinThrombosisOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithDeepVeinThrombosisOldCasePatientIndicator",
		    maleBetween0And39WithDeepVeinThrombosisOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "DVT.O.M.039",
		    "Old case DeepVeinThrombosis Male",
		    new Mapped(maleBetween0And39WithDeepVeinThrombosisOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		CompositionCohortDefinition femaleBetween0And39WithDeepVeinThrombosisOldCasePatient = new CompositionCohortDefinition();
		femaleBetween0And39WithDeepVeinThrombosisOldCasePatient
		        .setName("femaleBetween0And39WithDeepVeinThrombosisOldCasePatient");
		femaleBetween0And39WithDeepVeinThrombosisOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		femaleBetween0And39WithDeepVeinThrombosisOldCasePatient.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		femaleBetween0And39WithDeepVeinThrombosisOldCasePatient
		        .addParameter(new Parameter("endDate", "endDate", Date.class));
		femaleBetween0And39WithDeepVeinThrombosisOldCasePatient.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		femaleBetween0And39WithDeepVeinThrombosisOldCasePatient.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		femaleBetween0And39WithDeepVeinThrombosisOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldDeepVeinThrombosis, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithDeepVeinThrombosisOldCasePatient.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		femaleBetween0And39WithDeepVeinThrombosisOldCasePatient.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		femaleBetween0And39WithDeepVeinThrombosisOldCasePatient.setCompositionString("1 and 2 and (not 3)");
		
		CohortIndicator femaleBetween0And39WithDeepVeinThrombosisOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithDeepVeinThrombosisOldCasePatientIndicator",
		    femaleBetween0And39WithDeepVeinThrombosisOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "DVT.O.F.039",
		    "Old case DeepVeinThrombosis Female",
		    new Mapped(femaleBetween0And39WithDeepVeinThrombosisOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		// 40 +
		
		CompositionCohortDefinition maleOldCasepatientsAbove40YearsWithDeepVeinThrombosis = new CompositionCohortDefinition();
		maleOldCasepatientsAbove40YearsWithDeepVeinThrombosis
		        .setName("maleOldCasepatientsAbove40YearsWithDeepVeinThrombosis");
		maleOldCasepatientsAbove40YearsWithDeepVeinThrombosis.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		maleOldCasepatientsAbove40YearsWithDeepVeinThrombosis.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		maleOldCasepatientsAbove40YearsWithDeepVeinThrombosis.addParameter(new Parameter("endDate", "endDate", Date.class));
		maleOldCasepatientsAbove40YearsWithDeepVeinThrombosis.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		maleOldCasepatientsAbove40YearsWithDeepVeinThrombosis.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		maleOldCasepatientsAbove40YearsWithDeepVeinThrombosis.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldDeepVeinThrombosis, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleOldCasepatientsAbove40YearsWithDeepVeinThrombosis.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientAbove40Years, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		maleOldCasepatientsAbove40YearsWithDeepVeinThrombosis.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		maleOldCasepatientsAbove40YearsWithDeepVeinThrombosis.setCompositionString("1 and 2 and 3");
		
		CohortIndicator maleOldCasepatientsAbove40YearsWithDeepVeinThrombosisIndicator = Indicators.newCohortIndicator(
		    "maleOldCasepatientsAbove40YearsWithDeepVeinThrombosisIndicator",
		    maleOldCasepatientsAbove40YearsWithDeepVeinThrombosis,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "DVT.O.M.40",
		    "Old case DeepVeinThrombosis Male above 40",
		    new Mapped(maleOldCasepatientsAbove40YearsWithDeepVeinThrombosisIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		CompositionCohortDefinition femaleOldCasepatientsAbove40YearsWithDeepVeinThrombosis = new CompositionCohortDefinition();
		femaleOldCasepatientsAbove40YearsWithDeepVeinThrombosis
		        .setName("femaleOldCasepatientsAbove40YearsWithDeepVeinThrombosis");
		femaleOldCasepatientsAbove40YearsWithDeepVeinThrombosis.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		femaleOldCasepatientsAbove40YearsWithDeepVeinThrombosis.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		femaleOldCasepatientsAbove40YearsWithDeepVeinThrombosis
		        .addParameter(new Parameter("endDate", "endDate", Date.class));
		femaleOldCasepatientsAbove40YearsWithDeepVeinThrombosis.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		femaleOldCasepatientsAbove40YearsWithDeepVeinThrombosis.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		femaleOldCasepatientsAbove40YearsWithDeepVeinThrombosis.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldDeepVeinThrombosis, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleOldCasepatientsAbove40YearsWithDeepVeinThrombosis.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientAbove40Years, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		femaleOldCasepatientsAbove40YearsWithDeepVeinThrombosis.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		femaleOldCasepatientsAbove40YearsWithDeepVeinThrombosis.setCompositionString("1 and 2 and (not 3)");
		
		CohortIndicator femaleOldCasepatientsAbove40YearsWithDeepVeinThrombosisIndicator = Indicators.newCohortIndicator(
		    "femaleOldCasepatientsAbove40YearsWithDeepVeinThrombosisIndicator",
		    femaleOldCasepatientsAbove40YearsWithDeepVeinThrombosis,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "DVT.O.F.40",
		    "Old case DeepVeinThrombosis Female above 40",
		    new Mapped(femaleOldCasepatientsAbove40YearsWithDeepVeinThrombosisIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		// New patients with Renal failure
		
		SqlCohortDefinition newPatientWithRenalFailure = newPatientWithNCDsDiagnosisObsByStartDateAndEndDate(
		    conceptRenalFailure, combinedRenalFailure);
		...
		maleBetween0And39WithRenalFailure.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithRenalFailure, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39WithRenalFailure.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		...
		CohortIndicator maleBetween0And39WithRenalFailureIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithRenalFailureIndicator", maleBetween0And39WithRenalFailure,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "RF.N.M.039",
		    "New Case patients with RenalFailure Male",
		    new Mapped(maleBetween0And39WithRenalFailureIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39WithRenalFailure.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithRenalFailure, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithRenalFailure.getSearches().put(
		...
		CohortIndicator femaleBetween0And39WithRenalFailureIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithRenalFailureIndicator", femaleBetween0And39WithRenalFailure,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn("RF.N.F.039", "New case RenalFailure Female", new Mapped(femaleBetween0And39WithRenalFailureIndicator,
		        ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		dsd.addColumn(
		    "RF.N.M.40",
		    "New case RenalFailure Male above 40",
		...
		dsd.addColumn(
		    "RF.N.F.40",
		    "New case RenalFailure Female above 40",
		...
		SqlCohortDefinition oldRenalFailure = oldPatientWithNCDsDiagnosisObsByStartDateAndEndDateWithOutProgram(
		    conceptRenalFailure, combinedRenalFailure);
		...
		maleBetween0And39WithRenalFailureOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		maleBetween0And39WithRenalFailureOldCasePatient.getSearches().put(
		    "1",
		...
		CohortIndicator maleBetween0And39WithRenalFailureOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithRenalFailureOldCasePatientIndicator", maleBetween0And39WithRenalFailureOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "RF.O.M.039",
		    "Old case RenalFailure Male",
		    new Mapped(maleBetween0And39WithRenalFailureOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39WithRenalFailureOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		femaleBetween0And39WithRenalFailureOldCasePatient
		        .addParameter(new Parameter("onOrBefore", "onOrBefore", Date.class));
		femaleBetween0And39WithRenalFailureOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldRenalFailure, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithRenalFailureOldCasePatient.getSearches().put(
		...
		CohortIndicator femaleBetween0And39WithRenalFailureOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithRenalFailureOldCasePatientIndicator", femaleBetween0And39WithRenalFailureOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "RF.O.F.039",
		    "Old case RenalFailure Female",
		    new Mapped(femaleBetween0And39WithRenalFailureOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		dsd.addColumn(
		    "RF.O.M.40",
		    "Old case RenalFailure Male above 40",
		...
		dsd.addColumn(
		    "RF.O.F.40",
		    "Old case RenalFailure Female above 40",
		...
		SqlCohortDefinition newPatientWithOtherChronicKidney = newPatientWithNCDsDiagnosisObsByStartDateAndEndDate(
		    conceptOtherChronicKidneyDisease, combinedOtherChronicKidneyDisease);
		...
		maleBetween0And39WithOtherChronicKidney.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithOtherChronicKidney, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39WithOtherChronicKidney.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		...
		CohortIndicator maleBetween0And39WithOtherChronicKidneyIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithOtherChronicKidneyIndicator", maleBetween0And39WithOtherChronicKidney,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OCK.N.M.039",
		    "New Case patients with OtherChronicKidney Male",
		    new Mapped(maleBetween0And39WithOtherChronicKidneyIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39WithOtherChronicKidney.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithOtherChronicKidney, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithOtherChronicKidney.getSearches().put(
		...
		CohortIndicator femaleBetween0And39WithOtherChronicKidneyIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithOtherChronicKidneyIndicator", femaleBetween0And39WithOtherChronicKidney,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OCK.N.F.039",
		    "New case OtherChronicKidney Female",
		    new Mapped(femaleBetween0And39WithOtherChronicKidneyIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		malepatientsAbove40YearsWithOtherChronicKidney.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		malepatientsAbove40YearsWithOtherChronicKidney.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithOtherChronicKidney, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		malepatientsAbove40YearsWithOtherChronicKidney.getSearches().put(
		...
		CohortIndicator malepatientsAbove40YearsWithOtherChronicKidneyIndicator = Indicators.newCohortIndicator(
		    "malepatientsAbove40YearsWithOtherChronicKidneyIndicator", malepatientsAbove40YearsWithOtherChronicKidney,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OCK.N.M.40",
		    "New case OtherChronicKidney Male above 40",
		    new Mapped(malepatientsAbove40YearsWithOtherChronicKidneyIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femalepatientsAbove40YearsWithOtherChronicKidney.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		femalepatientsAbove40YearsWithOtherChronicKidney.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithOtherChronicKidney, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femalepatientsAbove40YearsWithOtherChronicKidney.getSearches().put(
		...
		CohortIndicator femalepatientsAbove40YearsWithOtherChronicKidneyIndicator = Indicators.newCohortIndicator(
		    "femalepatientsAbove40YearsWithOtherChronicKidneyIndicator", femalepatientsAbove40YearsWithOtherChronicKidney,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OCK.N.F.40",
		    "New case OtherChronicKidney Female above 40",
		    new Mapped(femalepatientsAbove40YearsWithOtherChronicKidneyIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		// IV.R. 4 Old case patient with OtherChronicKidney
		
		SqlCohortDefinition oldOtherChronicKidney = oldPatientWithNCDsDiagnosisObsByStartDateAndEndDateWithOutProgram(
		    conceptOtherChronicKidneyDisease, combinedOtherChronicKidneyDisease);
		
		// 0-39
		
		CompositionCohortDefinition maleBetween0And39WithOtherChronicKidneyOldCasePatient = new CompositionCohortDefinition();
		maleBetween0And39WithOtherChronicKidneyOldCasePatient
		        .setName("maleBetween0And39WithOtherChronicKidneyOldCasePatient");
		maleBetween0And39WithOtherChronicKidneyOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		maleBetween0And39WithOtherChronicKidneyOldCasePatient.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		maleBetween0And39WithOtherChronicKidneyOldCasePatient.addParameter(new Parameter("endDate", "endDate", Date.class));
		maleBetween0And39WithOtherChronicKidneyOldCasePatient.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		maleBetween0And39WithOtherChronicKidneyOldCasePatient.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		maleBetween0And39WithOtherChronicKidneyOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldOtherChronicKidney, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39WithOtherChronicKidneyOldCasePatient.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		maleBetween0And39WithOtherChronicKidneyOldCasePatient.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		maleBetween0And39WithOtherChronicKidneyOldCasePatient.setCompositionString("1 and 2 and 3");
		
		CohortIndicator maleBetween0And39WithOtherChronicKidneyOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithOtherChronicKidneyOldCasePatientIndicator",
		    maleBetween0And39WithOtherChronicKidneyOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OCK.O.M.039",
		    "Old case OtherChronicKidney Male",
		    new Mapped(maleBetween0And39WithOtherChronicKidneyOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		CompositionCohortDefinition femaleBetween0And39WithOtherChronicKidneyOldCasePatient = new CompositionCohortDefinition();
		femaleBetween0And39WithOtherChronicKidneyOldCasePatient
		        .setName("femaleBetween0And39WithOtherChronicKidneyOldCasePatient");
		femaleBetween0And39WithOtherChronicKidneyOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		femaleBetween0And39WithOtherChronicKidneyOldCasePatient.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		femaleBetween0And39WithOtherChronicKidneyOldCasePatient
		        .addParameter(new Parameter("endDate", "endDate", Date.class));
		femaleBetween0And39WithOtherChronicKidneyOldCasePatient.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		femaleBetween0And39WithOtherChronicKidneyOldCasePatient.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		femaleBetween0And39WithOtherChronicKidneyOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldOtherChronicKidney, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithOtherChronicKidneyOldCasePatient.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		femaleBetween0And39WithOtherChronicKidneyOldCasePatient.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		femaleBetween0And39WithOtherChronicKidneyOldCasePatient.setCompositionString("1 and 2 and (not 3)");
		
		CohortIndicator femaleBetween0And39WithOtherChronicKidneyOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithOtherChronicKidneyOldCasePatientIndicator",
		    femaleBetween0And39WithOtherChronicKidneyOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OCK.O.F.039",
		    "Old case OtherChronicKidney Female",
		    new Mapped(femaleBetween0And39WithOtherChronicKidneyOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		// 40 +
		
		CompositionCohortDefinition maleOldCasepatientsAbove40YearsWithOtherChronicKidney = new CompositionCohortDefinition();
		maleOldCasepatientsAbove40YearsWithOtherChronicKidney
		        .setName("maleOldCasepatientsAbove40YearsWithOtherChronicKidney");
		maleOldCasepatientsAbove40YearsWithOtherChronicKidney.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		maleOldCasepatientsAbove40YearsWithOtherChronicKidney.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		maleOldCasepatientsAbove40YearsWithOtherChronicKidney.addParameter(new Parameter("endDate", "endDate", Date.class));
		maleOldCasepatientsAbove40YearsWithOtherChronicKidney.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		maleOldCasepatientsAbove40YearsWithOtherChronicKidney.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		maleOldCasepatientsAbove40YearsWithOtherChronicKidney.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldOtherChronicKidney, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleOldCasepatientsAbove40YearsWithOtherChronicKidney.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientAbove40Years, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		maleOldCasepatientsAbove40YearsWithOtherChronicKidney.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		maleOldCasepatientsAbove40YearsWithOtherChronicKidney.setCompositionString("1 and 2 and 3");
		
		CohortIndicator maleOldCasepatientsAbove40YearsWithOtherChronicKidneyIndicator = Indicators.newCohortIndicator(
		    "maleOldCasepatientsAbove40YearsWithOtherChronicKidneyIndicator",
		    maleOldCasepatientsAbove40YearsWithOtherChronicKidney,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OCK.O.M.40",
		    "Old case OtherChronicKidney Male above 40",
		    new Mapped(maleOldCasepatientsAbove40YearsWithOtherChronicKidneyIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		CompositionCohortDefinition femaleOldCasepatientsAbove40YearsWithOtherChronicKidney = new CompositionCohortDefinition();
		femaleOldCasepatientsAbove40YearsWithOtherChronicKidney
		        .setName("femaleOldCasepatientsAbove40YearsWithOtherChronicKidney");
		femaleOldCasepatientsAbove40YearsWithOtherChronicKidney.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		femaleOldCasepatientsAbove40YearsWithOtherChronicKidney.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		femaleOldCasepatientsAbove40YearsWithOtherChronicKidney
		        .addParameter(new Parameter("endDate", "endDate", Date.class));
		femaleOldCasepatientsAbove40YearsWithOtherChronicKidney.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		femaleOldCasepatientsAbove40YearsWithOtherChronicKidney.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		femaleOldCasepatientsAbove40YearsWithOtherChronicKidney.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldOtherChronicKidney, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleOldCasepatientsAbove40YearsWithOtherChronicKidney.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientAbove40Years, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		femaleOldCasepatientsAbove40YearsWithOtherChronicKidney.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		femaleOldCasepatientsAbove40YearsWithOtherChronicKidney.setCompositionString("1 and 2 and (not 3)");
		
		CohortIndicator femaleOldCasepatientsAbove40YearsWithOtherChronicKidneyIndicator = Indicators.newCohortIndicator(
		    "femaleOldCasepatientsAbove40YearsWithOtherChronicKidneyIndicator",
		    femaleOldCasepatientsAbove40YearsWithOtherChronicKidney,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "OCK.O.F.40",
		    "Old case OtherChronicKidney Female above 40",
		    new Mapped(femaleOldCasepatientsAbove40YearsWithOtherChronicKidneyIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		// New patients with MetabolicUnspecified
		
		SqlCohortDefinition newPatientWithMetabolicUnspecified = newPatientWithNCDDiagnosisObsByStartDateAndEndDate(
		    ICD11Concepts, icd11OtherEndocrineAndMetabolicDisease);
		...
		maleBetween0And39WithMetabolicUnspecified.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithMetabolicUnspecified, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39WithMetabolicUnspecified.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		...
		CohortIndicator maleBetween0And39WithMetabolicUnspecifiedIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithMetabolicUnspecifiedIndicator", maleBetween0And39WithMetabolicUnspecified,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "MU.N.M.039",
		    "New Case patients with MetabolicUnspecified Male",
		    new Mapped(maleBetween0And39WithMetabolicUnspecifiedIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39WithMetabolicUnspecified
		        .addParameter(new Parameter("effectiveDate", "effectiveDate", Date.class));
		...
		femaleBetween0And39WithMetabolicUnspecified.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithMetabolicUnspecified, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithMetabolicUnspecified.getSearches().put(
		...
		CohortIndicator femaleBetween0And39WithMetabolicUnspecifiedIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithMetabolicUnspecifiedIndicator", femaleBetween0And39WithMetabolicUnspecified,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "MU.N.F.039",
		    "New case MetabolicUnspecified Female",
		    new Mapped(femaleBetween0And39WithMetabolicUnspecifiedIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		malepatientsAbove40YearsWithMetabolicUnspecified.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		malepatientsAbove40YearsWithMetabolicUnspecified.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithMetabolicUnspecified, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		malepatientsAbove40YearsWithMetabolicUnspecified.getSearches().put(
		...
		CohortIndicator malepatientsAbove40YearsWithMetabolicUnspecifiedIndicator = Indicators.newCohortIndicator(
		    "malepatientsAbove40YearsWithMetabolicUnspecifiedIndicator", malepatientsAbove40YearsWithMetabolicUnspecified,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "MU.N.M.40",
		    "New case MetabolicUnspecified Male above 40",
		    new Mapped(malepatientsAbove40YearsWithMetabolicUnspecifiedIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femalepatientsAbove40YearsWithMetabolicUnspecified.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		...
		femalepatientsAbove40YearsWithMetabolicUnspecified
		        .addParameter(new Parameter("onOrBefore", "onOrBefore", Date.class));
		femalepatientsAbove40YearsWithMetabolicUnspecified.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newPatientWithMetabolicUnspecified, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femalepatientsAbove40YearsWithMetabolicUnspecified.getSearches().put(
		...
		CohortIndicator femalepatientsAbove40YearsWithMetabolicUnspecifiedIndicator = Indicators.newCohortIndicator(
		    "femalepatientsAbove40YearsWithMetabolicUnspecifiedIndicator",
		    femalepatientsAbove40YearsWithMetabolicUnspecified,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "MU.N.F.40",
		    "New case MetabolicUnspecified Female above 40",
		    new Mapped(femalepatientsAbove40YearsWithMetabolicUnspecifiedIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		// IV.R. 4 Old case patient with MetabolicUnspecified
		
		SqlCohortDefinition oldMetabolicUnspecified = oldPatientWithNCDDiagnosisObsByStartDateAndEndDate(ICD11Concepts,
		    icd11OtherEndocrineAndMetabolicDisease);
		
		// 0-39
		
		CompositionCohortDefinition maleBetween0And39WithMetabolicUnspecifiedOldCasePatient = new CompositionCohortDefinition();
		maleBetween0And39WithMetabolicUnspecifiedOldCasePatient
		        .setName("maleBetween0And39WithMetabolicUnspecifiedOldCasePatient");
		maleBetween0And39WithMetabolicUnspecifiedOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		maleBetween0And39WithMetabolicUnspecifiedOldCasePatient.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		maleBetween0And39WithMetabolicUnspecifiedOldCasePatient
		        .addParameter(new Parameter("endDate", "endDate", Date.class));
		maleBetween0And39WithMetabolicUnspecifiedOldCasePatient.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		maleBetween0And39WithMetabolicUnspecifiedOldCasePatient.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		maleBetween0And39WithMetabolicUnspecifiedOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldMetabolicUnspecified, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleBetween0And39WithMetabolicUnspecifiedOldCasePatient.getSearches().put(
		    "2",
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		maleBetween0And39WithMetabolicUnspecifiedOldCasePatient.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		maleBetween0And39WithMetabolicUnspecifiedOldCasePatient.setCompositionString("1 and 2 and 3");
		
		CohortIndicator maleBetween0And39WithMetabolicUnspecifiedOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39WithMetabolicUnspecifiedOldCasePatientIndicator",
		    maleBetween0And39WithMetabolicUnspecifiedOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "MU.O.M.039",
		    "Old case MetabolicUnspecified Male",
		    new Mapped(maleBetween0And39WithMetabolicUnspecifiedOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		CompositionCohortDefinition femaleBetween0And39WithMetabolicUnspecifiedOldCasePatient = new CompositionCohortDefinition();
		femaleBetween0And39WithMetabolicUnspecifiedOldCasePatient
		        .setName("femaleBetween0And39WithMetabolicUnspecifiedOldCasePatient");
		femaleBetween0And39WithMetabolicUnspecifiedOldCasePatient.addParameter(new Parameter("effectiveDate",
		        "effectiveDate", Date.class));
		femaleBetween0And39WithMetabolicUnspecifiedOldCasePatient.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		femaleBetween0And39WithMetabolicUnspecifiedOldCasePatient.addParameter(new Parameter("endDate", "endDate",
		        Date.class));
		femaleBetween0And39WithMetabolicUnspecifiedOldCasePatient.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		femaleBetween0And39WithMetabolicUnspecifiedOldCasePatient.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		femaleBetween0And39WithMetabolicUnspecifiedOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldMetabolicUnspecified, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39WithMetabolicUnspecifiedOldCasePatient.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		femaleBetween0And39WithMetabolicUnspecifiedOldCasePatient.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		femaleBetween0And39WithMetabolicUnspecifiedOldCasePatient.setCompositionString("1 and 2 and (not 3)");
		
		CohortIndicator femaleBetween0And39WithMetabolicUnspecifiedOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39WithMetabolicUnspecifiedOldCasePatientIndicator",
		    femaleBetween0And39WithMetabolicUnspecifiedOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "MU.O.F.039",
		    "Old case MetabolicUnspecified Female",
		    new Mapped(femaleBetween0And39WithMetabolicUnspecifiedOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		// 40 +
		
		CompositionCohortDefinition maleOldCasepatientsAbove40YearsWithMetabolicUnspecified = new CompositionCohortDefinition();
		maleOldCasepatientsAbove40YearsWithMetabolicUnspecified
		        .setName("maleOldCasepatientsAbove40YearsWithMetabolicUnspecified");
		maleOldCasepatientsAbove40YearsWithMetabolicUnspecified.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		maleOldCasepatientsAbove40YearsWithMetabolicUnspecified.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		maleOldCasepatientsAbove40YearsWithMetabolicUnspecified
		        .addParameter(new Parameter("endDate", "endDate", Date.class));
		maleOldCasepatientsAbove40YearsWithMetabolicUnspecified.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		maleOldCasepatientsAbove40YearsWithMetabolicUnspecified.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		maleOldCasepatientsAbove40YearsWithMetabolicUnspecified.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldMetabolicUnspecified, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		maleOldCasepatientsAbove40YearsWithMetabolicUnspecified.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientAbove40Years, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		maleOldCasepatientsAbove40YearsWithMetabolicUnspecified.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		maleOldCasepatientsAbove40YearsWithMetabolicUnspecified.setCompositionString("1 and 2 and 3");
		
		CohortIndicator maleOldCasepatientsAbove40YearsWithMetabolicUnspecifiedIndicator = Indicators.newCohortIndicator(
		    "maleOldCasepatientsAbove40YearsWithMetabolicUnspecifiedIndicator",
		    maleOldCasepatientsAbove40YearsWithMetabolicUnspecified,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "MU.O.M.40",
		    "Old case MetabolicUnspecified Male above 40",
		    new Mapped(maleOldCasepatientsAbove40YearsWithMetabolicUnspecifiedIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		CompositionCohortDefinition femaleOldCasepatientsAbove40YearsWithMetabolicUnspecified = new CompositionCohortDefinition();
		femaleOldCasepatientsAbove40YearsWithMetabolicUnspecified
		        .setName("femaleOldCasepatientsAbove40YearsWithMetabolicUnspecified");
		femaleOldCasepatientsAbove40YearsWithMetabolicUnspecified.addParameter(new Parameter("effectiveDate",
		        "effectiveDate", Date.class));
		femaleOldCasepatientsAbove40YearsWithMetabolicUnspecified.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		femaleOldCasepatientsAbove40YearsWithMetabolicUnspecified.addParameter(new Parameter("endDate", "endDate",
		        Date.class));
		femaleOldCasepatientsAbove40YearsWithMetabolicUnspecified.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		femaleOldCasepatientsAbove40YearsWithMetabolicUnspecified.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		femaleOldCasepatientsAbove40YearsWithMetabolicUnspecified.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldMetabolicUnspecified, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleOldCasepatientsAbove40YearsWithMetabolicUnspecified.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientAbove40Years, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		femaleOldCasepatientsAbove40YearsWithMetabolicUnspecified.getSearches().put("3",
		    new Mapped<CohortDefinition>(male, null));
		femaleOldCasepatientsAbove40YearsWithMetabolicUnspecified.setCompositionString("1 and 2 and (not 3)");
		
		CohortIndicator femaleOldCasepatientsAbove40YearsWithMetabolicUnspecifiedIndicator = Indicators.newCohortIndicator(
		    "femaleOldCasepatientsAbove40YearsWithMetabolicUnspecifiedIndicator",
		    femaleOldCasepatientsAbove40YearsWithMetabolicUnspecified,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "MU.O.F.40",
		    "Old case MetabolicUnspecified Female above 40",
		    new Mapped(femaleOldCasepatientsAbove40YearsWithMetabolicUnspecifiedIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		// New case patient with CoronaryArteryDisease
		
		SqlCohortDefinition newCoronaryArteryDisease = newPatientWithNCDDiagnosisObsByStartDateAndEndDate(ICD11Concepts,
		...
		maleBetween0And39CoronaryArteryDisease.getSearches().put(
		    "1",
		...
		CohortIndicator maleBetween0And39CoronaryArteryDiseaseIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39CoronaryArteryDiseaseIndicator", maleBetween0And39CoronaryArteryDisease,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "CAD.N.M.039",
		    "New case CoronaryArteryDisease Male",
		    new Mapped(maleBetween0And39CoronaryArteryDiseaseIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		femaleBetween0And39CoronaryArteryDisease.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(newCoronaryArteryDisease, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39CoronaryArteryDisease.getSearches().put(
		...
		CohortIndicator femaleBetween0And39CoronaryArteryDiseaseIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39CoronaryArteryDiseaseIndicator", femaleBetween0And39CoronaryArteryDisease,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "CAD.N.F.039",
		    "New case CoronaryArteryDisease Female",
		    new Mapped(femaleBetween0And39CoronaryArteryDiseaseIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		dsd.addColumn(
		    "CAD.N.M.40",
		    "New case CoronaryArteryDisease Male above 40",
		...
		femalepatientsAbove40YearsWithCoronaryArteryDisease.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientAbove40Years, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		femalepatientsAbove40YearsWithCoronaryArteryDisease.getSearches().put("3",
		...
		dsd.addColumn(
		    "CAD.N.F.40",
		    "New case CoronaryArteryDisease Female above 40",
		...
		SqlCohortDefinition oldCoronaryArteryDisease = oldPatientWithNCDDiagnosisObsByStartDateAndEndDate(ICD11Concepts,
		    coronaryArteryDisease);
		...
		maleBetween0And39CoronaryArteryDiseaseOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		maleBetween0And39CoronaryArteryDiseaseOldCasePatient
		        .addParameter(new Parameter("startDate", "startDate", Date.class));
		maleBetween0And39CoronaryArteryDiseaseOldCasePatient.addParameter(new Parameter("endDate", "endDate", Date.class));
		maleBetween0And39CoronaryArteryDiseaseOldCasePatient
		        .addParameter(new Parameter("onOrAfter", "onOrAfter", Date.class));
		maleBetween0And39CoronaryArteryDiseaseOldCasePatient.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		maleBetween0And39CoronaryArteryDiseaseOldCasePatient.getSearches().put(
		    "1",
		...
		maleBetween0And39CoronaryArteryDiseaseOldCasePatient.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		maleBetween0And39CoronaryArteryDiseaseOldCasePatient.getSearches()
		        .put("3", new Mapped<CohortDefinition>(male, null));
		maleBetween0And39CoronaryArteryDiseaseOldCasePatient.setCompositionString("1 and 2 and 3");
		
		CohortIndicator maleBetween0And39CoronaryArteryDiseaseOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "maleBetween0And39CoronaryArteryDiseaseOldCasePatientIndicator",
		    maleBetween0And39CoronaryArteryDiseaseOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "CAD.O.M.039",
		    "Old case CoronaryArteryDisease Male",
		    new Mapped(maleBetween0And39CoronaryArteryDiseaseOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		
		CompositionCohortDefinition femaleBetween0And39CoronaryArteryDiseaseOldCasePatient = new CompositionCohortDefinition();
		femaleBetween0And39CoronaryArteryDiseaseOldCasePatient
		        .setName("femaleBetween0And39AsthmaIntermittantOldCasePatient");
		femaleBetween0And39CoronaryArteryDiseaseOldCasePatient.addParameter(new Parameter("effectiveDate", "effectiveDate",
		        Date.class));
		femaleBetween0And39CoronaryArteryDiseaseOldCasePatient.addParameter(new Parameter("startDate", "startDate",
		        Date.class));
		femaleBetween0And39CoronaryArteryDiseaseOldCasePatient.addParameter(new Parameter("endDate", "endDate", Date.class));
		femaleBetween0And39CoronaryArteryDiseaseOldCasePatient.addParameter(new Parameter("onOrAfter", "onOrAfter",
		        Date.class));
		femaleBetween0And39CoronaryArteryDiseaseOldCasePatient.addParameter(new Parameter("onOrBefore", "onOrBefore",
		        Date.class));
		femaleBetween0And39CoronaryArteryDiseaseOldCasePatient.getSearches().put(
		    "1",
		    new Mapped<CohortDefinition>(oldCoronaryArteryDisease, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")));
		femaleBetween0And39CoronaryArteryDiseaseOldCasePatient.getSearches().put(
		    ...
		    new Mapped<CohortDefinition>(patientBetweenZeroAndThirtyNineYears, ParameterizableUtil
		            .createParameterMappings("effectiveDate=${effectiveDate}")));
		femaleBetween0And39CoronaryArteryDiseaseOldCasePatient.getSearches().put("3",
		    new Mapped<CohortDefinition>(female, null));
		femaleBetween0And39CoronaryArteryDiseaseOldCasePatient.setCompositionString("1 and 2 and (not 3)");
		
		CohortIndicator femaleBetween0And39CoronaryArteryDiseaseOldCasePatientIndicator = Indicators.newCohortIndicator(
		    "femaleBetween0And39CoronaryArteryDiseaseOldCasePatientIndicator",
		    femaleBetween0And39CoronaryArteryDiseaseOldCasePatient,
		    ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate}"));
		dsd.addColumn(
		    "CAD.O.F.039",
		    "Old case CoronaryArteryDisease Female",
		    new Mapped(femaleBetween0And39CoronaryArteryDiseaseOldCasePatientIndicator, ParameterizableUtil
		            .createParameterMappings("startDate=${startDate},endDate=${endDate}")), "");
		...
		dsd.addColumn(
		    "CAD.O.M.40",
		    "Old case CoronaryArteryDisease Male above 40",
		...
		dsd.addColumn(
		    "CAD.O.F.40",
		    "Old case CoronaryArteryDisease Female above 40",
	...
	private SqlCohortDefinition newPatientWithNCDDiagnosisObsByStartDateAndEndDate(Concept NcdDiagnosis, Concept NcdAnswer) {
		...
		SqlCohortDefinition patientWithIDCObs = new SqlCohortDefinition("select o.person_id from obs o "
		        + " JOIN patient_program pp on pp.patient_id=o.person_id" + " where o.voided= 0 and o.concept_id = "
		        + NcdDiagnosis.getConceptId() + " " + " and o.value_coded = " + NcdAnswer.getConceptId() + " "
		        + " and pp.voided=0 and pp.date_completed is null" + " and pp.date_enrolled>= :startDate "
	...
	private SqlCohortDefinition newPatientWithNCDsDiagnosisObsByStartDateAndEndDate(List<Concept> NcdDiagnosis,
	        List<Concept> NcdAnswers) {
	...
	private SqlCohortDefinition oldPatientWithNCDsDiagnosisObsByStartDateAndEndDate(List<Concept> NcdDiagnosis,
	        List<Concept> NcdAnswers) {
	...
	private SqlCohortDefinition oldPatientWithNCDsDiagnosisObsByStartDateAndEndDateWithOutProgram(
	        List<Concept> NcdDiagnosis, List<Concept> NcdAnswers) {
