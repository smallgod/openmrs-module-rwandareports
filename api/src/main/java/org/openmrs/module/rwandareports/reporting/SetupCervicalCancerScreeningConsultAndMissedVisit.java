...
import org.openmrs.module.rwandareports.filter.HighestValueDateTimeUptoDate;
...
public class SetupCervicalCancerScreeningConsultAndMissedVisit {

    protected final static Log log = LogFactory.getLog(SetupCervicalCancerScreeningConsultAndMissedVisit.class);
...
//		ReportDefinition missedVisitReportDefinition = createMissedVisitReportDefinition(context);
        ...
        ReportDesign consultReporDesign = Helper.createRowPerPatientXlsOverviewReportDesign(consultReportDefinition, "OncologyCervicalCancerScreeningConsultSheet.xls","OncologyCervicalCancerScreeningConsultSheet.xls_", null);
        ReportDesign missedVisitReporDesign = Helper.createRowPerPatientXlsOverviewReportDesign(missedVisitReportDefinition, "OncologyCervicalCancerScreeningMissedVisitSheet.xls","OncologyCervicalCancerScreeningMissedVisitSheet.xls_", null);
    ...
    public void delete() {
        ...
        for (ReportDesign rd : rs.getAllReportDesigns(false)) {
            if ("OncologyCervicalCancerScreeningConsultSheet.xls_".equals(rd.getName())) {
                rs.purgeReportDesign(rd);
            }
            if ("OncologyCervicalCancerScreeningMissedVisitSheet.xls_".equals(rd.getName())) {
                rs.purgeReportDesign(rd);
            }
        }
        Helper.purgeReportDefinition("ONC-Cervical Cancer Screening Consultation Sheet");
        Helper.purgeReportDefinition("ONC-Cervical Cancer Screening Missed Visit");
    ...
    private ReportDefinition createConsultReportDefinition() {
        ...
        reportDefinition.setName("ONC-Cervical Cancer Screening Consultation Sheet");
...
//        reportDefinition.addParameter(encounterType);
        ...
        patientsWithVisitInPeriod.setQuery("select distinct o.person_id from obs o, encounter e where  e.encounter_type= "+ oncologyCervicalScreeningExamination.getEncounterType().getEncounterTypeId() +" and e.encounter_type in ("+oncologyBreastScreeningExamination.getEncounterType().getEncounterTypeId()+","+oncologyCervicalScreeningExamination.getEncounterType().getEncounterTypeId()+")  and o.encounter_id=e.encounter_id and e.voided=0 and o.voided=0 and o.concept_id="
                + returnVisitDate.getConceptId()
                + " and o.value_datetime>= :startDate and o.value_datetime<= :endDate");
...
//	private ReportDefinition createMissedVisitReportDefinition(EvaluationContext context) {
    ...
    private ReportDefinition createMissedVisitReportDefinition() {
        ...
        ReportDefinition reportDefinition = new ReportDefinition();
        reportDefinition.setName("ONC-Cervical Cancer Screening Missed Visit");
        //reportDefinition.addParameter(new Parameter("location", "Health Center", Location.class));
...
//		locationDefinition.setQuery(sql.toString());
        ...
        missedVisitsql.append(" o.encounter_id = (SELECT recent.encounter_id from encounter recent where  recent.encounter_type= "+ oncologyCervicalScreeningExamination.getEncounterType().getEncounterTypeId() +" and o.person_id=recent.patient_id and recent.encounter_datetime < :endDate order by recent.encounter_datetime desc limit 1) ");
        ...
        missedVisitsql.append(" )) and o.encounter_id in (select encSec.encounter_id from encounter encSec where encSec.encounter_type= "+ oncologyCervicalScreeningExamination.getEncounterType().getEncounterTypeId() +" and encSec.voided=0 and encSec.patient_id = o.person_id) ");
...
//
//		missedVisitsql.append(" ( :encounterType is null or encounter_type= :encounterType ) and voided=0 order by encounter_datetime desc) as e group by e.patient_id) as last_Visit ");
//
...
//				"where o.encounter_id=e.encounter_id and (:encounterType is null or e.encounter_type= :encounterType) " +
...
//		SqlCohortDefinition missedVisit=new SqlCohortDefinition("select o.person_id from obs o,encounter e where o.encounter_id=e.encounter_id and (:encounterType is null or e.encounter_type= :encounterType) and o.voided=0 and o.concept_id="+gp.getConcept(GlobalPropertiesManagement.RETURN_VISIT_DATE).getConceptId()+" and datediff(:endDate,o.value_datetime)<400 and datediff(:endDate,o.value_datetime)>7 and o.value_datetime< :endDate and o.person_id not in (select patient_id from encounter where encounter_datetime>o.value_datetime and encounter_type in ("+oncologyBreastScreeningExamination.getEncounterType().getEncounterTypeId()+","+oncologyCervicalScreeningExamination.getEncounterType().getEncounterTypeId()+")) and o.person_id not in (select person_id from person where dead=1)");
        ...
        //SqlCohortDefinition missedVisit=new SqlCohortDefinition("select e.patient_id from encounter e where (:encounterType is null or e.encounter_type= :encounterType) and e.voided=0");
...
//        dataSetDef.addParameter(new Parameter("encounterType", "encounterType", EncounterType.class));
        ...
        dataSetDef.addColumn(RowPerPatientColumns.getMostRecentEncounterOfSpecificEncountertypeInperiod("nextVisitOfEnctype",gp.getConcept(GlobalPropertiesManagement.RETURN_VISIT_DATE),
                null,null,cervicalScreeningEncounterTypes,null,"yyyy/MM/dd"), new HashMap<String, Object>());
...
//        dataSetDefinition.addParameter(new Parameter("encounterType", "encounterType", EncounterType.class));
        ...
        sortCriteria.addSortElement("nextScheduledDate", SortCriteria.SortDirection.DESC);
...
//		sortCriteria.addSortElement("nextRDV", SortDirection.ASC);
        ...
        dataSetDefinition.addColumn(RowPerPatientColumns.getMostRecentEncounterOfSpecificEncountertypeInperiod("nextVisitOfEnctype",gp.getConcept(GlobalPropertiesManagement.RETURN_VISIT_DATE),
                null,null,cervicalScreeningEncounterTypes,null,"yyyy/MM/dd") , ParameterizableUtil.createParameterMappings("endDate=${endDate}"));
...
//		Context.getAdministrationService().getGlobalProperty("reports.locationToLocationConceptMatch");
	...
	/*	dataSetDefinition.addColumn(RowPerPatientColumns.getObservationInMostRecentEncounterOfTheTypes("lastEncounterLocation",gp.getConcept(GlobalPropertiesManagement.RETURN_VISIT_DATE),cervicalScreeningEncounterTypes,new LocationObsFilter()), new HashMap<String, Object>());
		dataSetDefinition.addColumn(RowPerPatientColumns.getObservationInMostRecentEncounterOfTheTypes("lastEncounter",gp.getConcept(GlobalPropertiesManagement.RETURN_VISIT_DATE),cervicalScreeningEncounterTypes,null), new HashMap<String, Object>());
*/

        dataSetDefinition.addColumn(RowPerPatientColumns.getRecentEncounter("recentencounterdate", null,cervicalScreeningEncounterTypes,"dd/MM/yyyy", null), new HashMap<String, Object>());

        dataSetDefinition.addColumn(RowPerPatientColumns.getRecentEncounter("recentencounterLocation", null,cervicalScreeningEncounterTypes,"dd/MM/yyyy", new LocationEncounterFilter()), new HashMap<String, Object>());
        ...
        dataSetDefinition.addColumn(RowPerPatientColumns.getObservationInMostRecentEncounter("nextScheduledDate",gp.getConcept(GlobalPropertiesManagement.RETURN_VISIT_DATE),null,cervicalScreeningEncounterTypes,null), new HashMap<String, Object>());
        ...
        dataSetDefinition.addColumn(RowPerPatientColumns.getObservationInMostRecentEncounter("referred",hasPatientBeenReferred_cervical,null,cervicalScreeningEncounterTypes,new DateFormatFilter()), new HashMap<String, Object>());
        dataSetDefinition.addColumn(RowPerPatientColumns.getPatientAddress("Address", true, true, true, true), new HashMap<String, Object>());
        ...
        dataSetDefinition.addColumn(RowPerPatientColumns.getObservationInMostRecentEncounter("referredTo",referredToConcept,null,cervicalScreeningEncounterTypes,null), new HashMap<String, Object>());
