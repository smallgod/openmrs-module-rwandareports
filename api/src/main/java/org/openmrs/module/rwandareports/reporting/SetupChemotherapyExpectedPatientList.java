...
private void createDataSetDefinition(ReportDefinition reportDefinition) {
	...
	//Add Filters
    dataSetDefinition.addFilter(Cohorts.getMondayToSundayPatientReturnVisit(visitForms,ChemotherapyInpatientWardVisit), ParameterizableUtil.createParameterMappings("end=${endDate},start=${startDate}"));
