...
public class SetupPDCMissedVisits {
	...
	private void createDataSetDefinition(ReportDefinition reportDefinition) {
		...
		dataSetDefinition.addFilter(Cohorts.createPatientsLateForPDCVisit(returnVisitDate,pdcEncType,1), ParameterizableUtil.createParameterMappings("endDate=${endDate}"));
