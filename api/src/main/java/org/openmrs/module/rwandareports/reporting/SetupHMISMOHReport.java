...
//============================================================================
        ...
        patientWithUrethralDischargeInMen.setQuery("select grouped.patient_id from (select * from (select * from encounter e WHERE form_id in (8,17) and voided=0 order by e.encounter_datetime desc) ordered group by ordered.patient_id) grouped, obs o where grouped.encounter_id=o.encounter_id and o.concept_id=13362 and o.value_coded=10908 and grouped.encounter_datetime >= :onOrAfter and grouped.encounter_datetime<= :onOrBefore");
        ...
        patientWithVaginalDischarge.setQuery("select grouped.patient_id from (select * from (select * from encounter e WHERE form_id in (8,17) and voided=0 order by e.encounter_datetime desc) ordered group by ordered.patient_id) grouped, obs o where grouped.encounter_id=o.encounter_id and o.concept_id=13362 and o.value_coded=10909 and grouped.encounter_datetime >= :onOrAfter and grouped.encounter_datetime<= :onOrBefore");
        ...
        patientWithGenitalUlceration.setQuery("select grouped.patient_id from (select * from (select * from encounter e WHERE form_id in (8,17) and voided=0 order by e.encounter_datetime desc) ordered group by ordered.patient_id) grouped, obs o where grouped.encounter_id=o.encounter_id and o.concept_id=13362 and o.value_coded=2738 and grouped.encounter_datetime >= :onOrAfter and grouped.encounter_datetime<= :onOrBefore");
        ...
        patientWithInguinalBubo.setQuery("select grouped.patient_id from (select * from (select * from encounter e WHERE form_id in (8,17) and voided=0 order by e.encounter_datetime desc) ordered group by ordered.patient_id) grouped, obs o where grouped.encounter_id=o.encounter_id and o.concept_id=13362 and o.value_coded=13357 and grouped.encounter_datetime >= :onOrAfter and grouped.encounter_datetime<= :onOrBefore");
        ...
        patientWithPainfulSwellingOfEpididymisOrTestis.setQuery("select grouped.patient_id from (select * from (select * from encounter e WHERE form_id in (8,17) and voided=0 order by e.encounter_datetime desc) ordered group by ordered.patient_id) grouped, obs o where grouped.encounter_id=o.encounter_id and o.concept_id=13362 and o.value_coded=13358 and grouped.encounter_datetime >= :onOrAfter and grouped.encounter_datetime<= :onOrBefore");
        ...
        patientWithPelvicPainInWomen.setQuery("select grouped.patient_id from (select * from (select * from encounter e WHERE form_id in (8,17) and voided=0 order by e.encounter_datetime desc) ordered group by ordered.patient_id) grouped, obs o where grouped.encounter_id=o.encounter_id and o.concept_id=13362 and o.value_coded=902 and grouped.encounter_datetime >= :onOrAfter and grouped.encounter_datetime<= :onOrBefore");
        ...
        patientWithVenerealVegetation.setQuery("select grouped.patient_id from (select * from (select * from encounter e WHERE form_id in (8,17) and voided=0 order by e.encounter_datetime desc) ordered group by ordered.patient_id) grouped, obs o where grouped.encounter_id=o.encounter_id and o.concept_id=13362 and o.value_coded=13359 and grouped.encounter_datetime >= :onOrAfter and grouped.encounter_datetime<= :onOrBefore");
        ...
        patientWithPurulentConjunctivitisNewborn.setQuery("select grouped.patient_id from (select * from (select * from encounter e WHERE form_id in (8,17) and voided=0 order by e.encounter_datetime desc) ordered group by ordered.patient_id) grouped, obs o where grouped.encounter_id=o.encounter_id and o.concept_id=13362 and o.value_coded=13360 and grouped.encounter_datetime >= :onOrAfter and grouped.encounter_datetime<= :onOrBefore");
        ...
        patientWithSyphilisTestsTurnedPositive.setQuery("select grouped.patient_id from (select * from (select * from encounter e WHERE form_id in (8,17) and voided=0 order by e.encounter_datetime desc) ordered group by ordered.patient_id) grouped, obs o where grouped.encounter_id=o.encounter_id and o.concept_id=223 and o.value_coded=703 and grouped.encounter_datetime >= :onOrAfter and grouped.encounter_datetime<= :onOrBefore");
        ...
        patientWithCasesHerpesSimplexVirusTestsTurnedPositive.setQuery("select grouped.patient_id from (select * from (select * from encounter e WHERE form_id in (8,17) and voided=0 order by e.encounter_datetime desc) ordered group by ordered.patient_id) grouped, obs o where grouped.encounter_id=o.encounter_id and o.concept_id=1373 and o.value_coded=703 and grouped.encounter_datetime >= :onOrAfter and grouped.encounter_datetime<= :onOrBefore");
        ...
        patientWithCasesChlamydiaTestsTurnedPositive.setQuery("select grouped.patient_id from (select * from (select * from encounter e WHERE form_id in (8,17) and voided=0 order by e.encounter_datetime desc) ordered group by ordered.patient_id) grouped, obs o where grouped.encounter_id=o.encounter_id and o.concept_id=13361 and o.value_coded=703 and grouped.encounter_datetime >= :onOrAfter and grouped.encounter_datetime<= :onOrBefore");
        ...
        patientWithCasesGonococcalTestsTurnedPositive.setQuery("select grouped.patient_id from (select * from (select * from encounter e WHERE form_id in (8,17) and voided=0 order by e.encounter_datetime desc) ordered group by ordered.patient_id) grouped, obs o where grouped.encounter_id=o.encounter_id and o.concept_id=893 and o.value_coded=703 and grouped.encounter_datetime >= :onOrAfter and grouped.encounter_datetime<= :onOrBefore");
        ...
        //===============================================
        // J15 Partners treated for STIs               form 74
        //===============================================
...
//====================================================
        ...
        coupleCounseledAndTestedForHIV.setQuery("select grouped.patient_id from (select * from (select * from encounter e WHERE form_id= "+VCTCounselingAndTesting.getFormId()+" and voided=0 order by e.encounter_datetime desc) ordered group by ordered.patient_id) grouped, obs o where grouped.encounter_id=o.encounter_id and o.concept_id=13221 and o.value_coded=13220 and grouped.encounter_datetime >= :onOrAfter and grouped.encounter_datetime <= :onOrBefore");
        ...
        discordantCouple.setQuery ("select grouped.patient_id from (select * from (select * from encounter e WHERE form_id ="+DiscordentCoupleForm.getFormId()+" and voided=0 order by e.encounter_datetime asc) ordered group by ordered.patient_id) grouped, obs o where grouped.encounter_id=o.encounter_id and o.concept_id=2355 and o.value_coded=6096 and grouped.encounter_datetime >= :onOrAfter and grouped.encounter_datetime <= :onOrBefore");;
        ...
        dsd.addColumn("F03","Number of male clients tested and received results",new Mapped(patientWithDiscordantCoupleIndicator,ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate},location=${location}")),"");
       ...
       /* CompositionCohortDefinition malepatientCounseledAndTestedForHIVAbove25Years=new CompositionCohortDefinition();
        ...
        HIVPositivePatientInFamillyPlanning.setQuery("select grouped.patient_id from (select * from (select * from encounter e WHERE form_id= 8 and voided=0 order by e.encounter_datetime desc)ordered group by ordered.patient_id) grouped, obs o where grouped.encounter_id=o.encounter_id and o.concept_id=374 and grouped.encounter_datetime >= :onOrAfter and grouped.encounter_datetime <= :onOrBefore");
        ...
        patientWithSevereMalnutrition.setQuery("select  grouped.patient_id from (select * from (select * from encounter e WHERE form_id ="+NutritionStatusMonitoring.getFormId()+" and voided=0 order by e.encounter_datetime asc) ordered group by ordered.patient_id) grouped, obs o where grouped.encounter_id=o.encounter_id and o.concept_id=13372 and o.value_coded=1313 and grouped.encounter_datetime >= :onOrAfter and grouped.encounter_datetime <= :onOrBefore");
        ...
        malepatientCounseledAndTestedForHIVBetween20An24Years.getSearches().put("2",new Mapped<CohortDefinition>(patientsWithAgeBetween20And24Years, ParameterizableUtil.createParameterMappings("effectiveDate=${effectiveDate}")));
        ...
        malePatientsBetween20An24YearsTestedAndReceivedResultsThroughPIT.getSearches().put("2",new Mapped<CohortDefinition>(patientsWithAgeBetween20And24Years, ParameterizableUtil.createParameterMappings("effectiveDate=${effectiveDate}")));
        ...
        patientTestedandReceivedResltsBetween20An24Years.getSearches().put("1",new Mapped<CohortDefinition>(patientsWithAgeBetween20And24Years, ParameterizableUtil.createParameterMappings("effectiveDate=${effectiveDate}")));
        ...
        femalepatientCounseledAndTestedForHIVBetween20An24Years.getSearches().put("2",new Mapped<CohortDefinition>(patientsWithAgeBetween20And24Years, ParameterizableUtil.createParameterMappings("effectiveDate=${effectiveDate}")));
        ...
        femalepatientCounseledAndTestedForHIVBetween20An24YearsThroughPIT.getSearches().put("2",new Mapped<CohortDefinition>(patientsWithAgeBetween20And24Years, ParameterizableUtil.createParameterMappings("effectiveDate=${effectiveDate}")));
        ...
        femalePatientTestedandReceivedResltsBetween20An24Years.getSearches().put("1",new Mapped<CohortDefinition>(patientsWithAgeBetween20And24Years, ParameterizableUtil.createParameterMappings("effectiveDate=${effectiveDate}")));
        ...
        CompositionCohortDefinition maleClientsAbove50YearsReceivedHIVResultsThroughPIT=new CompositionCohortDefinition();
        maleClientsAbove50YearsReceivedHIVResultsThroughPIT.setName("maleClientsAbove50YearsReceivedHIVResultsThroughPIT");
        maleClientsAbove50YearsReceivedHIVResultsThroughPIT.addParameter(new Parameter("onOrAfter","onOrAfter",Date.class));
        maleClientsAbove50YearsReceivedHIVResultsThroughPIT.addParameter(new Parameter("onOrBefore","onOrBefore",Date.class));
        maleClientsAbove50YearsReceivedHIVResultsThroughPIT.addParameter(new Parameter("effectiveDate","effectiveDate",Date.class));
        maleClientsAbove50YearsReceivedHIVResultsThroughPIT.getSearches().put("1",new Mapped<CohortDefinition>(males, null));
        maleClientsAbove50YearsReceivedHIVResultsThroughPIT.getSearches().put("2",new Mapped<CohortDefinition>(patientsWithAge50AndAbove, ParameterizableUtil.createParameterMappings("effectiveDate=${effectiveDate}")));
        maleClientsAbove50YearsReceivedHIVResultsThroughPIT.getSearches().put("3",new Mapped<CohortDefinition>(patientCounseledAndTestedForHIVTroughtPIT, ParameterizableUtil.createParameterMappings("onOrAfter=${onOrAfter},onOrBefore=${onOrBefore}")));
        malePatientsBellow1YearTestedAndReceivedResults.setCompositionString("(1 AND 2 AND 3)");

        CohortIndicator maleClientsAbove50YearsReceivedHIVResultsThroughPITIndicator= Indicators.newCohortIndicator("maleClientsAbove50YearsReceivedHIVResultsThroughPITIndicator",
                maleClientsAbove50YearsReceivedHIVResultsThroughPIT, ParameterizableUtil.createParameterMappings("onOrAfter=${startDate},onOrBefore=${endDate},effectiveDate=${endDate}"));
        dsd.addColumn("K32","Number of male clients tested and received results",new Mapped(maleClientsAbove50YearsReceivedHIVResultsThroughPITIndicator,ParameterizableUtil.createParameterMappings("startDate=${startDate},endDate=${endDate},location=${location}")),"");
