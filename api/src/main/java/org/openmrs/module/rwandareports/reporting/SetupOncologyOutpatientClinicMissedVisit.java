...
public class SetupOncologyOutpatientClinicMissedVisit extends SingleSetupReport {
	...
	public void setup() throws Exception {
		...
		props.put("repeatingSections", "sheet:1,row:7,dataset:datasetAll|sheet:2,row:7,dataset:dataset|sheet:3,row:7,dataset:dataset2|sheet:4,row:7,dataset:dataset3|sheet:5,row:7,dataset:dataset4");
	...
	private void createDataSetDefinition(ReportDefinition reportDefinition) {
		...
		dataSetDefinition4.addColumn(RowPerPatientColumns.getMostRecent("nextRDV", pathologyResultVisit, "dd/MMM/yyyy"), new HashMap<String, Object>());


		dataSetDefinition5.addColumn(RowPerPatientColumns.getMostRecent("nextRDVscheduledVisit", scheduledVisit, "dd/MMM/yyyy"), new HashMap<String, Object>());
		dataSetDefinition5.addColumn(RowPerPatientColumns.getMostRecent("nextRDVbiopsyResultVisit", biopsyResultVisit, "dd/MMM/yyyy"), new HashMap<String, Object>());
		dataSetDefinition5.addColumn(RowPerPatientColumns.getMostRecent("nextRDVspecialVisit", specialVisit, "dd/MMM/yyyy"), new HashMap<String, Object>());
		dataSetDefinition5.addColumn(RowPerPatientColumns.getMostRecent("nextRDVpathologyVisit", pathologyResultVisit,"dd/MMM/yyyy"),new HashMap<String, Object>());
		...
		dataSetDefinition4.addColumn(RowPerPatientColumns.getMostRecent("nextRDVDate", pathologyResultVisit, "yyyy/MM/dd"), new HashMap<String, Object>());
		...
		dataSetDefinition5.addColumn(RowPerPatientColumns.getStateOfPatient("diagnosis", oncologyProgram, diagnosis, null), new HashMap<String, Object>());
		...
		dataSetDefinition5.addColumn(RowPerPatientColumns.getMostRecent("diagnosisNew", confirmedDiagnosis, null), new HashMap<String, Object>());
		...
		dataSetDefinition5.addColumn(RowPerPatientColumns.getMostRecent("telephone", telephone, null), new HashMap<String, Object>());
		...
		dataSetDefinition5.addColumn(RowPerPatientColumns.getMostRecent("telephone2", telephone2, null), new HashMap<String, Object>());
		...
		dataSetDefinition5.addColumn(RowPerPatientColumns.getAccompRelationship("accompagnateur"), new HashMap<String, Object>());
