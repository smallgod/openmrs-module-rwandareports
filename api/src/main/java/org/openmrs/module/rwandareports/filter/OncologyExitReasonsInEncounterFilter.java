...
public Object filter(Object value) {	
	...
	Concept exitReasonReferred=Context.getConceptService().getConceptByUuid(Context.getAdministrationService().getGlobalProperty("reports.exitReasonReferred"));
	
	Concept exitReasonUnExpectedDeath=Context.getConceptService().getConceptByUuid(Context.getAdministrationService().getGlobalProperty("reports.exitReasonUnExpectedDeath"));
	
	Concept exitReasonUnPriorTreatmentDeath=Context.getConceptService().getConceptByUuid(Context.getAdministrationService().getGlobalProperty("reports.exitReasonUnPriorTreatmentDeath"));	
