...
DROP PROCEDURE IF EXISTS sp_mamba_view_fact_insurance_report;

CREATE PROCEDURE sp_mamba_view_fact_insurance_report()
...
BEGIN
    ...
    SET @select_stmt = CONCAT('CREATE OR REPLACE VIEW mamba_view_fact_insurance_report AS
